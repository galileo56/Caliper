...
complex (dp) function VacPol2(z)
  complex (dp), intent(in)    :: z
  complex (dp), dimension(12) :: r32
  complex (dp)                :: rz, r1, r2, r3, GGz, Pi1z

  rz = sqrt(z); r1 = sqrt(1 - z); r2 = 1 + r1; r3 = 1 - r1; Pi1z =  VacPol1(z)
  r32 = PowList(r3/r2, 12); GGz = Gz( u(z) )

  VacPol2 = -0.8705931079221861_dp - 4.76969262963348_dp * Pi1z - &
  14.513280990412627_dp * GGz * Pi1z * (1 - z) + GGz * (-1.342733077226607_dp &
  - 1.4297246736253244_dp/z**2 - 1.6672690081425396_dp/z) * (1 - z) + &
  ...
  (1 - z)**2)/z + ( GGz**2 * (0.818502957958217_dp - 0.3103216057696041_dp/z) * &
  (1 - z**2) )/z - ( 0.4627825174938722_dp * GGz**2 * (1 - z)**2 * &
  (1 + z) )/z

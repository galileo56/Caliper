...
(2.6854661544532146_dp*(r0**2-2._dp*r0*rz+rz**2)*(-1._dp+  &
...
(7.870586395257993e-2_dp*(r0**2-2._dp*r0*rz+rz**2)*(-2.5e-1_dp+  &
z**2)*(2.802528429206536e1_dp*z**3+rz**2*(1.4999999999999996_dp+  &
...
(3.9352931976289964e-2_dp*(r0**2-2._dp*r0*rz+rz**2)*(-2.5e-1_dp+  &
z**2)*(2.802528429206536e1_dp*z**3+rz**2*(1.4999999999999996_dp+  &
z)))/(d2*rz**2*z**5))+PL2**2*((-2.798430718313952e-1_dp*(r0**2-  &
2._dp*r0*rz+rz**2)*(-0.5_dp+z)*(0.5_dp+z)**2)/(d2*z**5)+((1+  &
2._dp*z)*(6.99607679578488e-2_dp*r0**2*rz**2*z-  &
1.7490191989462203e-1_dp*r0**2*rz**2*(0.5_dp+z)+  &
3.49803839789244e-2_dp*r0**2*z*(0.5_dp+z)+  &
3.49803839789244e-2_dp*rz**2*z*(0.5_dp+z)+  &
(1.049411519367732e-1_dp*(r0**2-2._dp*r0*rz+rz**2)*z*(-2.5e-1_dp+  &
z**2))/(0.5_dp+r0*rz-1._dp*z)))/z**6)+  &
...
l3*((3.49803839789244e-2_dp*PL1*r0*rz*(r0**2-2._dp*r0*rz+  &
rz**2)*(0.5_dp+z)**2)/(d2*z**5)+  &
(6.99607679578488e-2_dp*PL2*r0*rz*(r0**2-2._dp*r0*rz+  &
rz**2)*(0.5_dp+z)**2)/(d2*z**5)+  &
(1.049411519367732e-1_dp*PL3*(r0**2-2._dp*r0*rz+rz**2)*(0.5_dp+  &
z)*(-2.5e-1_dp+z**2))/(d2*z**5)+  &
(2.098823038735464e-1_dp*PL4*(r0**2-2._dp*r0*rz+rz**2)*(0.5_dp+  &
z)*(-2.5e-1_dp+z**2))/(d2*z**5)+(r0*rz*(1.5768154513889756e-2_dp+  &
...
l5*((-3.49803839789244e-2_dp*PL1*r0*rz*(r0**2-2._dp*r0*rz+  &
rz**2)*(0.5_dp+z)**2)/(d2*z**5)-  &
(6.99607679578488e-2_dp*PL2*r0*rz*(r0**2-2._dp*r0*rz+  &
rz**2)*(0.5_dp+z)**2)/(d2*z**5)-  &
(1.049411519367732e-1_dp*PL3*(r0**2-2._dp*r0*rz+rz**2)*(0.5_dp+  &
z)*(-2.5e-1_dp+z**2))/(d2*z**5)-  &
(2.098823038735464e-1_dp*PL4*(r0**2-2._dp*r0*rz+rz**2)*(0.5_dp+  &
z)*(-2.5e-1_dp+z**2))/(d2*z**5)+(r0**2*(7.884077256944878e-3_dp+  &
2.9978935505327797e-2_dp*z+2.3509379518035014e-3_dp*z**2-  &
...
l4*((-3.49803839789244e-2_dp*PL1*r0*rz*(r0**2-2._dp*r0*rz+  &
rz**2)*(0.5_dp+z)**2)/((0.5_dp+r0*rz-1._dp*z)*z**5)-  &
(6.99607679578488e-2_dp*PL2*r0*rz*(r0**2-2._dp*r0*rz+  &
rz**2)*(0.5_dp+z)**2)/((0.5_dp+r0*rz-1._dp*z)*z**5)-  &
(1.049411519367732e-1_dp*PL3*(r0**2-2._dp*r0*rz+rz**2)*(0.5_dp+  &
z)*(-2.5e-1_dp+z**2))/((0.5_dp+r0*rz-1._dp*z)*z**5)-  &
(2.098823038735464e-1_dp*PL4*(r0**2-2._dp*r0*rz+rz**2)*(0.5_dp+  &
z)*(-2.5e-1_dp+z**2))/((0.5_dp+r0*rz-1._dp*z)*z**5)+  &
(r0**2*(7.884077256944878e-3_dp+2.9978935505327797e-2_dp*z+  &
2.3509379518035014e-3_dp*z**2-1.7295897377329486e-1_dp*z**3-  &
...
4.832709028445988e-1_dp*z**4))/((0.5_dp+r0*rz-1._dp*z)*z**5))+  &
l2*((6.99607679578488e-2_dp*PL1*r0*rz*(r0**2-2._dp*r0*rz+  &
rz**2)*(0.5_dp+z)**2)/(d2*z**5)+  &
(1.399215359156976e-1_dp*PL2*r0*rz*(r0**2-2._dp*r0*rz+  &
rz**2)*(0.5_dp+z)**2)/(d2*z**5)+  &
(2.098823038735464e-1_dp*PL3*(r0**2-2._dp*r0*rz+rz**2)*(0.5_dp+  &
z)*(-2.5e-1_dp+z**2))/(d2*z**5)+  &
(4.197646077470928e-1_dp*PL4*(r0**2-2._dp*r0*rz+rz**2)*(0.5_dp+  &
z)*(-2.5e-1_dp+z**2))/(d2*z**5)+(r0*rz*(3.153630902777951e-2_dp+  &
...
3.459179475465897e-1_dp*z**3+  &
4.832709028445988e-1_dp*z**4))/(d2*z**5))+  &
PL1**2*((-6.996076795784882e-2_dp*r0*rz*(-0.5_dp+z)*(0.5_dp+z)**2  &
...
(1.74901919894622e-2_dp*rz**2*z*(0.5_dp+z)**2+  &
r0**2*(1.74901919894622e-2_dp*z*(0.5_dp+z)**2+  &
...
PL3*((-2.62352879841933e-2_dp*(-2._dp+r0/rz+rz/r0)*(1-2._dp*z)*(1  &
+2._dp*z)*(1-4._dp*z**2))/(d2*z**5)+  &
(4.197646077470928e-1_dp*r0*rz*z**2*(0.5_dp+z)+  &
(3.9352931976289964e-2_dp*(2-(1._dp*r0)/rz-(1._dp*rz)/r0)*z*(1-  &
4._dp*z**2)**2)/(-1._dp-2._dp*r0*rz+2._dp*z)+  &
2.098823038735464e-1_dp*r0*rz*z*(-2.5e-1_dp+z**2)-  &
1.0494115193677322_dp*r0*rz*(0.5_dp+z)*(-2.5e-1_dp+z**2)+  &
(1.049411519367732e-1_dp*r0*z*(0.5_dp+z)*(-2.5e-1_dp+z**2))/rz+  &
(1.049411519367732e-1_dp*rz*z*(0.5_dp+z)*(-2.5e-1_dp+  &
z**2))/r0)/z**6)+PL4*((-5.24705759683866e-2_dp*(-2._dp+r0/rz+  &
rz/r0)*(1-2._dp*z)*(1+2._dp*z)*(1-4._dp*z**2))/(d2*z**5)+  &
(8.395292154941856e-1_dp*r0*rz*z**2*(0.5_dp+z)+  &
(7.870586395257993e-2_dp*(2-(1._dp*r0)/rz-(1._dp*rz)/r0)*z*(1-  &
4._dp*z**2)**2)/(-1._dp-2._dp*r0*rz+2._dp*z)+  &
4.197646077470928e-1_dp*r0*rz*z*(-2.5e-1_dp+z**2)-  &
2.0988230387354645_dp*r0*rz*(0.5_dp+z)*(-2.5e-1_dp+z**2)+  &
(2.098823038735464e-1_dp*r0*z*(0.5_dp+z)*(-2.5e-1_dp+z**2))/rz+  &
(2.098823038735464e-1_dp*rz*z*(0.5_dp+z)*(-2.5e-1_dp+  &
...
1._dp*z)*z**6))+l1**4*((l2**2*(-5.465684996706939e-3_dp+  &
...
2.391237186059285e-3_dp*(3._dp*r0*rz+z+6._dp*r0*z**1.5_dp-  &
6._dp*z**2)-1.3664212491767347e-3_dp*(3._dp*r0*rz+z+  &
6._dp*r0*z**1.5_dp-6._dp*z**2)**2+(9.56494874423714e-4_dp*(-1._dp+  &
(0.5_dp*r0)/rz+(0.5_dp*rz)/r0)*z*(-1._dp+4._dp*z**2))/(1+r0*rz-  &
1._dp*z)+(4.78247437211857e-4_dp*(8._dp-(4._dp*r0)/rz-  &
(4._dp*rz)/r0)*z*(-1._dp+4._dp*z**2))/(-8._dp*r0*rz+8._dp*z)+  &
(1.0931369993413877e-3_dp*(-1._dp+(0.5_dp*r0)/rz+  &
(0.5_dp*rz)/r0)*z*(3._dp*r0*rz+z+6._dp*r0*z**1.5_dp-  &
6._dp*z**2)*(-1._dp+4._dp*z**2))/(1+r0*rz-1._dp*z)+  &
(5.465684996706938e-4_dp*(8._dp-(4._dp*r0)/rz-  &
(4._dp*rz)/r0)*z*(3._dp*r0*rz+z+6._dp*r0*z**1.5_dp-  &
6._dp*z**2)*(-1._dp+4._dp*z**2))/(-8._dp*r0*rz+8._dp*z)+  &
4.78247437211857e-4_dp*z*(1+(1.5_dp*r0)/rz+9._dp*r0*rz-1.2e1_dp*z+  &
(1.5_dp*rz+3._dp*z**1.5_dp)/r0)+  &
5.465684996706938e-4_dp*z*(3._dp*r0*rz+z+6._dp*r0*z**1.5_dp-  &
6._dp*z**2)*(1+(1.5_dp*r0)/rz+9._dp*r0*rz-1.2e1_dp*z+(1.5_dp*rz+  &
3._dp*z**1.5_dp)/r0))/z**6+(l3*(2.391237186059285e-3_dp-  &
5.738969246542284e-3_dp*z**2+  &
4.372547997365551e-3_dp*z**2*(3._dp*r0*rz+z+6._dp*r0*z**1.5_dp-  &
6._dp*z**2)+(1.0931369993413877e-3_dp*(-1._dp+(0.5_dp*r0)/rz+  &
(0.5_dp*rz)/r0)*z*(1-4._dp*z**2)**2)/(1+r0*rz-1._dp*z)+  &
(5.465684996706938e-4_dp*(8._dp-(4._dp*r0)/rz-(4._dp*rz)/r0)*z*(1-  &
4._dp*z**2)**2)/(-8._dp*r0*rz+8._dp*z)-  &
2.7328424983534694e-3_dp*(3._dp*r0*rz+z+6._dp*r0*z**1.5_dp-  &
6._dp*z**2)*(-1._dp+4._dp*z**2)+5.465684996706938e-4_dp*z*(-1._dp+  &
4._dp*z**2)*(1+(1.5_dp*r0)/rz+9._dp*r0*rz-1.2e1_dp*z+(1.5_dp*rz+  &
3._dp*z**1.5_dp)/r0)))/z**6+l2*((l3*(-5.465684996706939e-3_dp+  &
2.6235287984193305e-2_dp*z**2-1.749019198946221e-2_dp*z**4))/z**6+  &
(4.78247437211857e-3_dp-1.147793849308457e-2_dp*z**2+  &
8.745095994731102e-3_dp*z**2*(3._dp*r0*rz+z+6._dp*r0*z**1.5_dp-  &
6._dp*z**2)+(2.1862739986827755e-3_dp*(-1._dp+(0.5_dp*r0)/rz+  &
(0.5_dp*rz)/r0)*z*(1-4._dp*z**2)**2)/(1+r0*rz-1._dp*z)+  &
(1.0931369993413877e-3_dp*(8._dp-(4._dp*r0)/rz-(4._dp*rz)/r0)*z*(1  &
-4._dp*z**2)**2)/(-8._dp*r0*rz+8._dp*z)-  &
5.465684996706939e-3_dp*(3._dp*r0*rz+z+6._dp*r0*z**1.5_dp-  &
6._dp*z**2)*(-1._dp+4._dp*z**2)+1.0931369993413877e-3_dp*z*(-1._dp+  &
4._dp*z**2)*(1+(1.5_dp*r0)/rz+9._dp*r0*rz-1.2e1_dp*z+(1.5_dp*rz+  &
3._dp*z**1.5_dp)/r0))/z**6))+  &
...
6.996076795784882e-2_dp*rz**2)*(-0.5_dp+z)*(0.5_dp+  &
z)**2)/(d2*z**5)+((1+  &
2._dp*z)*(6.99607679578488e-2_dp*r0**2*rz**2*z-  &
1.7490191989462203e-1_dp*r0**2*rz**2*(0.5_dp+z)+  &
3.49803839789244e-2_dp*r0**2*z*(0.5_dp+z)+  &
3.49803839789244e-2_dp*rz**2*z*(0.5_dp+z)+  &
(5.24705759683866e-2_dp*(r0**2-2._dp*r0*rz+rz**2)*z*(-2.5e-1_dp+  &
z**2))/(0.5_dp+r0*rz-1._dp*z)))/z**6)+  &
...
(1.0494115193677322e-1_dp*rz**2*(-0.5_dp+z)*z*(0.5_dp+z)**2+  &
r0**2*(1.0494115193677322e-1_dp*(-0.5_dp+z)*z*(0.5_dp+z)**2+  &
...
(5.24705759683866e-2_dp*rz**2*(-0.5_dp+z)*z*(0.5_dp+z)**2+  &
r0**2*(5.24705759683866e-2_dp*(-0.5_dp+z)*z*(0.5_dp+z)**2+  &
...
l1*((1.399215359156976e-1_dp*l2**2*r0*rz*(r0**2-2._dp*r0*rz+  &
rz**2)*(0.5_dp+z)**2)/(d2*z**5)+  &
(3.49803839789244e-2_dp*l3**2*r0*rz*(r0**2-2._dp*r0*rz+  &
rz**2)*(0.5_dp+z)**2)/(d2*z**5)+(1.0476837861865178e2_dp*(r0**2-  &
2._dp*r0*rz+rz**2)*(0.5_dp+r0*rz-1._dp*z)*(-1._dp+  &
z)*(-3.7913315126399993e-1_dp+z)*(1+z)*(rz+r0*(-0.5_dp+z)-  &
1._dp*z**1.5_dp))/(d1**3*r0*z**2)+  &
((-3.702260139950978_dp*d2*(-2._dp+r0/rz+rz/r0)*(1-  &
1._dp*z)**2*(1+z))/z-(5.370932308906429_dp*d2**2*(r0**2-  &
2._dp*r0*rz+rz**2)*(-1._dp+z)*(1.0647869616635923_dp+  &
...
PL2**2*((5.596861436627904e-1_dp*(r0**2-2._dp*r0*rz+  &
rz**2)*(2.5e-1_dp-1._dp*z**2)**2)/(d2*r0*rz*z**5)+((1+  &
2._dp*z)*(-2.798430718313952e-1_dp*r0*rz*(-0.5_dp+z)*z-  &
1.399215359156976e-1_dp*r0*rz*z*(0.5_dp+z)-  &
(5.24705759683866e-2_dp*(2-(1._dp*r0)/rz-(1._dp*rz)/r0)*(1-  &
2._dp*z)*z*(1-4._dp*z**2))/(-1._dp-2._dp*r0*rz+2._dp*z)+  &
...
8.155196485502605e-1_dp*z**5)))/(r0*rz*(r0*rz-1._dp*z)*(1+r0*rz-  &
1._dp*z)*z**6)+l5*((1.399215359156976e-1_dp*PL1*(r0**2-  &
2._dp*r0*rz+rz**2)*(-0.5_dp+z)*(0.5_dp+z)**2)/(d2*z**5)+  &
(2.798430718313952e-1_dp*PL2*(r0**2-2._dp*r0*rz+rz**2)*(-0.5_dp+  &
z)*(0.5_dp+z)**2)/(d2*z**5)+(1.311764399209665e-2_dp*PL3*(-2._dp+  &
r0/rz+rz/r0)*(1-2._dp*z)*(1+2._dp*z)*(1-4._dp*z**2))/(d2*z**5)+  &
(2.62352879841933e-2_dp*PL4*(-2._dp+r0/rz+rz/r0)*(1-2._dp*z)*(1+  &
2._dp*z)*(1-4._dp*z**2))/(d2*z**5)+  &
...
l4*((1.399215359156976e-1_dp*PL1*(r0**2-2._dp*r0*rz+  &
rz**2)*(-0.5_dp+z)*(0.5_dp+z)**2)/((0.5_dp+r0*rz-1._dp*z)*z**5)+  &
(2.798430718313952e-1_dp*PL2*(r0**2-2._dp*r0*rz+rz**2)*(-0.5_dp+  &
z)*(0.5_dp+z)**2)/((0.5_dp+r0*rz-1._dp*z)*z**5)+  &
(2.62352879841933e-2_dp*PL3*(2-(1._dp*r0)/rz-(1._dp*rz)/r0)*(1-  &
2._dp*z)*(1+2._dp*z)*(1-4._dp*z**2))/(z**5*(-1._dp-2._dp*r0*rz+  &
2._dp*z))+(5.24705759683866e-2_dp*PL4*(2-(1._dp*r0)/rz-  &
(1._dp*rz)/r0)*(1-2._dp*z)*(1+2._dp*z)*(1-  &
4._dp*z**2))/(z**5*(-1._dp-2._dp*r0*rz+2._dp*z))+  &
(r0*rz*(-1.5768154513889756e-2_dp-2.842156198287608e-2_dp*z+  &
1.152138661177042e-1_dp*z**2+3.5532169935380375e-1_dp*z**3-  &
2.085649922485806e-1_dp*z**4-9.665418056891976e-1_dp*z**5)+  &
rz**2*(7.884077256944878e-3_dp+1.421078099143804e-2_dp*z-  &
...
1._dp*z)*z**5))+PL1**2*((r0**2*(-4.372547997365551e-3_dp+  &
...
1.74901919894622e-2_dp*z**2-3.49803839789244e-2_dp*z**3)+  &
r0**2*(-3.498038397892442e-2_dp*(-0.5_dp+z)*z*(0.5_dp+z)**2+  &
...
r0/rz+rz/r0)*(1-4._dp*z**2)*(5.738969246542284e-3_dp+  &
...
3.9352931976289964e-1_dp*z**4)))/(r0*rz*(r0*rz-1._dp*z)*(1+r0*rz  &
-1._dp*z)*z**6))+PL4*(((-2._dp+r0/rz+rz/r0)*(1-  &
4._dp*z**2)*(1.147793849308457e-2_dp+3.935293197628995e-2_dp*r0*rz+  &
...
7.870586395257993e-1_dp*z**4)))/(r0*rz*(r0*rz-1._dp*z)*(1+r0*rz-  &
1._dp*z)*z**6))+PL1*((PL3*(6.5588219960483265e-2_dp-  &
...
2._dp*z)*(-2.798430718313952e-1_dp*r0*rz*(-0.5_dp+z)*z-  &
1.399215359156976e-1_dp*r0*rz*z*(0.5_dp+z)-  &
(2.62352879841933e-2_dp*(2-(1._dp*r0)/rz-(1._dp*rz)/r0)*(1-  &
2._dp*z)*z*(1-4._dp*z**2))/(-1._dp-2._dp*r0*rz+2._dp*z)+  &
r0*rz*(-1.7490191989462203e-1_dp+6.996076795784881e-1_dp*z**2)+  &
(1.74901919894622e-2_dp*r0*z-6.99607679578488e-2_dp*r0*z**3)/rz+  &
(1.74901919894622e-2_dp*rz*z-  &
...
1.838128510603061e-1_dp*z**5)))/(rz**2*(r0*rz-1._dp*z)*(1+r0*rz-  &
1._dp*z)*z**6))+PL2*((PL3*(1.3117643992096653e-1_dp-  &
...
2._dp*r0*rz+rz**2)*(0.5_dp+z)*(r0*rz**3+(2.802528429206536e1_dp-  &
5.605056858413072e1_dp*z)*z**3+rz**2*(1.791666666666667_dp-  &
1.666666666666667_dp*z+2._dp*r0*z**1.5_dp-  &
4._dp*z**2)))/(d2*rz**2*z**5)+  &
...
1.1028771063618361_dp*z**7)))/(rz**2*(r0*rz-1._dp*z)*(0.5_dp+  &
r0*rz-1._dp*z)*(1+r0*rz-1._dp*z)*z**6))+  &
l2*((1.399215359156976e-1_dp*l3*r0*rz*(r0**2-2._dp*r0*rz+  &
rz**2)*(0.5_dp+z)**2)/(d2*z**5)-  &
(6.99607679578488e-2_dp*l5*r0*rz*(r0**2-2._dp*r0*rz+  &
rz**2)*(0.5_dp+z)**2)/(d2*z**5)-  &
(6.99607679578488e-2_dp*l4*r0*rz*(r0**2-2._dp*r0*rz+  &
rz**2)*(0.5_dp+z)**2)/((0.5_dp+r0*rz-1._dp*z)*z**5)+  &
PL2*(((-6.996076795784881e-1_dp*r0**2+  &
1.3992153591569758_dp*r0*rz-  &
6.996076795784881e-1_dp*rz**2)*(-0.5_dp+z)*(0.5_dp+  &
z)**2)/(d2*z**5)+((1+  &
2._dp*z)*(1.399215359156976e-1_dp*r0**2*rz**2*z-  &
3.4980383978924405e-1_dp*r0**2*rz**2*(0.5_dp+z)+  &
6.99607679578488e-2_dp*r0**2*z*(0.5_dp+z)+  &
6.99607679578488e-2_dp*rz**2*z*(0.5_dp+z)+  &
(1.049411519367732e-1_dp*(r0**2-2._dp*r0*rz+rz**2)*z*(-2.5e-1_dp+  &
z**2))/(0.5_dp+r0*rz-1._dp*z)))/z**6)-  &
(5.24705759683866e-2_dp*(r0**2-2._dp*r0*rz+  &
...
rz**2*(7.500000000000001e-1_dp+2.0000000000000004_dp*z+  &
...
2.7984307183139516e-1_dp*r0*rz-  &
1.3992153591569765e-1_dp*rz**2)*(-0.5_dp+z)*(0.5_dp+  &
z)**2)/(d2*z**5)+(6.99607679578488e-2_dp*rz**2*z*(0.5_dp+z)**2+  &
r0**2*(6.99607679578488e-2_dp*z*(0.5_dp+z)**2+  &
rz**2*(-8.745095994731102e-2_dp-2.798430718313952e-1_dp*z-  &
2.0988230387354645e-1_dp*z**2)))/z**6)+  &
PL4*((-4.197646077470928e-1_dp*(r0**2-2._dp*r0*rz+rz**2)*(2.5e-1_dp  &
-1._dp*z**2)**2)/(d2*r0*rz*z**5)+  &
(2.098823038735464e-1_dp*rz**2*(-0.5_dp+z)*z*(0.5_dp+z)**2+  &
r0**2*(2.098823038735464e-1_dp*(-0.5_dp+z)*z*(0.5_dp+z)**2+  &
rz**2*(2.6235287984193305e-1_dp+4.197646077470929e-1_dp*z-  &
6.296469116206394e-1_dp*z**2-  &
8.39529215494186e-1_dp*z**3)))/(r0*rz*z**6))+  &
PL3*((-2.098823038735464e-1_dp*(r0**2-2._dp*r0*rz+rz**2)*(2.5e-1_dp  &
-1._dp*z**2)**2)/(d2*r0*rz*z**5)+  &
(1.0494115193677322e-1_dp*rz**2*(-0.5_dp+z)*z*(0.5_dp+z)**2+  &
r0**2*(1.0494115193677322e-1_dp*(-0.5_dp+z)*z*(0.5_dp+z)**2+  &
rz**2*(1.3117643992096653e-1_dp+2.0988230387354645e-1_dp*z-  &
3.148234558103197e-1_dp*z**2-  &
4.19764607747093e-1_dp*z**3)))/(r0*rz*z**6)))+  &
l3*((-3.49803839789244e-2_dp*l5*r0*rz*(r0**2-2._dp*r0*rz+  &
rz**2)*(0.5_dp+z)**2)/(d2*z**5)-  &
(3.49803839789244e-2_dp*l4*r0*rz*(r0**2-2._dp*r0*rz+  &
rz**2)*(0.5_dp+z)**2)/((0.5_dp+r0*rz-1._dp*z)*z**5)-  &
(2.62352879841933e-2_dp*(r0**2-2._dp*r0*rz+  &
rz**2)*(1.5025711289494927e-1_dp+2.708333333333333e-1_dp*z-  &
1.0978902364929275_dp*z**2-3.3859138459608698_dp*z**3+  &
1.9874471396525217_dp*z**4+9.210322050510145_dp*z**5+  &
r0**2*(z**3*(1.401264214603268e1_dp+2.802528429206536e1_dp*z)+  &
...
(5.24705759683866e-2_dp*(r0**2-2._dp*r0*rz+rz**2)*z*(-2.5e-1_dp+  &
z**2))/(0.5_dp+r0*rz-1._dp*z)))/z**6+  &
(6.996076795784881e-1_dp*r0*rz*(-0.5_dp+z)*(0.5_dp+z)**2+  &
...
1.3992153591569765e-1_dp*r0*rz-  &
6.996076795784882e-2_dp*rz**2)*(-0.5_dp+z)*(0.5_dp+  &
z)**2)/(d2*z**5)+(3.49803839789244e-2_dp*rz**2*z*(0.5_dp+z)**2+  &
r0**2*(3.49803839789244e-2_dp*z*(0.5_dp+z)**2+  &
rz**2*(-4.372547997365551e-2_dp-1.399215359156976e-1_dp*z-  &
1.0494115193677322e-1_dp*z**2)))/z**6)+  &
PL4*((-2.098823038735464e-1_dp*(r0**2-2._dp*r0*rz+rz**2)*(2.5e-1_dp  &
-1._dp*z**2)**2)/(d2*r0*rz*z**5)+  &
(1.0494115193677322e-1_dp*rz**2*(-0.5_dp+z)*z*(0.5_dp+z)**2+  &
r0**2*(1.0494115193677322e-1_dp*(-0.5_dp+z)*z*(0.5_dp+z)**2+  &
rz**2*(1.3117643992096653e-1_dp+2.0988230387354645e-1_dp*z-  &
3.148234558103197e-1_dp*z**2-  &
4.19764607747093e-1_dp*z**3)))/(r0*rz*z**6))+  &
PL3*((-1.049411519367732e-1_dp*(r0**2-2._dp*r0*rz+rz**2)*(2.5e-1_dp  &
-1._dp*z**2)**2)/(d2*r0*rz*z**5)+  &
(5.24705759683866e-2_dp*rz**2*(-0.5_dp+z)*z*(0.5_dp+z)**2+  &
r0**2*(5.24705759683866e-2_dp*(-0.5_dp+z)*z*(0.5_dp+z)**2+  &
rz**2*(6.5588219960483265e-2_dp+1.0494115193677322e-1_dp*z-  &
...
1._dp*z)**2)/z)/d1**3-(2.572125248638347e1_dp*d2**4*(-2._dp+r0/rz  &
+rz/r0)*(1-1._dp*z)**2)/(d1**4*z)+(l4*(2-(1._dp*r0)/rz-  &
(1._dp*rz)/r0)*(1-2._dp*z)*(1+2._dp*z)*(3.8259794976948562e-3_dp+  &
1.311764399209665e-2_dp*r0*rz+4.372547997365551e-3_dp*z+  &
2.62352879841933e-2_dp*r0*z**1.5_dp-  &
2.62352879841933e-2_dp*z**2))/(z**5*(-1._dp-2._dp*r0*rz+2._dp*z))+  &
(l5*(-2._dp+r0/rz+rz/r0)*(1-2._dp*z)*(1+  &
2._dp*z)*(1.9129897488474281e-3_dp+6.558821996048325e-3_dp*r0*rz+  &
2.1862739986827755e-3_dp*z+1.311764399209665e-2_dp*r0*z**1.5_dp-  &
1.311764399209665e-2_dp*z**2))/(d2*z**5)+((-2._dp+r0/rz+  &
rz/r0)*(8.3693301512075e-4_dp+1.9129897488474281e-3_dp*(3._dp*r0*rz  &
+z+6._dp*r0*z**1.5_dp-6._dp*z**2)+  &
1.0931369993413877e-3_dp*(3._dp*r0*rz+z+6._dp*r0*z**1.5_dp-  &
6._dp*z**2)**2))/(d2*z**5)+(PL2*(1.9129897488474281e-2_dp+  &
1.5303917990779425e-2_dp*(-0.5_dp+z)*z-  &
7.6519589953897125e-2_dp*z**2+1.5303917990779425e-2_dp*z*(0.5_dp+z)  &
-8.745095994731102e-3_dp*(1-2._dp*z)*z*(3._dp*r0*rz+z+  &
6._dp*r0*z**1.5_dp-6._dp*z**2)+2.1862739986827755e-2_dp*(1-  &
2._dp*z)*(1+2._dp*z)*(3._dp*r0*rz+z+6._dp*r0*z**1.5_dp-6._dp*z**2)  &
+8.745095994731102e-3_dp*z*(1+2._dp*z)*(3._dp*r0*rz+z+  &
6._dp*r0*z**1.5_dp-6._dp*z**2)-(8.745095994731102e-3_dp*(-1._dp+  &
(0.5_dp*r0)/rz+(0.5_dp*rz)/r0)*(1-2._dp*z)*z*(1+2._dp*z)*(-1._dp+  &
4._dp*z**2))/(1+r0*rz-1._dp*z)-(4.372547997365551e-3_dp*(8._dp-  &
(4._dp*r0)/rz-(4._dp*rz)/r0)*(1-2._dp*z)*z*(1+2._dp*z)*(-1._dp+  &
4._dp*z**2))/(-8._dp*r0*rz+8._dp*z)-4.372547997365551e-3_dp*(1-  &
2._dp*z)*z*(1+2._dp*z)*(1+(1.5_dp*r0)/rz+9._dp*r0*rz-1.2e1_dp*z+  &
(1.5_dp*rz+3._dp*z**1.5_dp)/r0)))/z**6+  &
(PL1*(9.56494874423714e-3_dp+7.6519589953897125e-3_dp*(-0.5_dp+z)*z  &
-3.8259794976948562e-2_dp*z**2+7.6519589953897125e-3_dp*z*(0.5_dp+  &
z)-4.372547997365551e-3_dp*(1-2._dp*z)*z*(3._dp*r0*rz+z+  &
6._dp*r0*z**1.5_dp-6._dp*z**2)+1.0931369993413877e-2_dp*(1-  &
2._dp*z)*(1+2._dp*z)*(3._dp*r0*rz+z+6._dp*r0*z**1.5_dp-6._dp*z**2)  &
+4.372547997365551e-3_dp*z*(1+2._dp*z)*(3._dp*r0*rz+z+  &
6._dp*r0*z**1.5_dp-6._dp*z**2)-(4.372547997365551e-3_dp*(-1._dp+  &
(0.5_dp*r0)/rz+(0.5_dp*rz)/r0)*(1-2._dp*z)*z*(1+2._dp*z)*(-1._dp+  &
4._dp*z**2))/(1+r0*rz-1._dp*z)-(2.1862739986827755e-3_dp*(8._dp-  &
(4._dp*r0)/rz-(4._dp*rz)/r0)*(1-2._dp*z)*z*(1+2._dp*z)*(-1._dp+  &
4._dp*z**2))/(-8._dp*r0*rz+8._dp*z)-2.1862739986827755e-3_dp*(1-  &
2._dp*z)*z*(1+2._dp*z)*(1+(1.5_dp*r0)/rz+9._dp*r0*rz-1.2e1_dp*z+  &
(1.5_dp*rz+3._dp*z**1.5_dp)/r0)))/z**6+  &
...
5.514385531809179e-1_dp*z**5)))/(r0*rz**2*(r0*rz-1._dp*z)*(1+  &
r0*rz-1._dp*z)*z**6)+l3**2*((1.0931369993413877e-3_dp*(-2._dp+  &
r0/rz+rz/r0)*(1-4._dp*z**2)**2)/(d2*z**5)+  &
(-8.745095994731102e-3_dp*rz**2*(-0.5_dp+z)*z*(0.5_dp+z)**2+  &
r0**2*(-8.745095994731102e-3_dp*(-0.5_dp+z)*z*(0.5_dp+z)**2+  &
...
4._dp*z**2)**2)/(d2*z**5)+(rz**2*z*(4.372547997365551e-3_dp+  &
...
2._dp*z)*(1+2._dp*z)*(-1._dp+4._dp*z**2))/(d2*z**5)+  &
(4.372547997365551e-3_dp*l4*(2-(1._dp*r0)/rz-(1._dp*rz)/r0)*(1-  &
2._dp*z)*(1+2._dp*z)*(-1._dp+4._dp*z**2))/(z**5*(-1._dp-  &
2._dp*r0*rz+2._dp*z))+((-2._dp+r0/rz+  &
rz/r0)*(1.9129897488474281e-3_dp+6.558821996048325e-3_dp*r0*rz+  &
2.1862739986827755e-3_dp*z+1.311764399209665e-2_dp*r0*z**1.5_dp-  &
1.311764399209665e-2_dp*z**2)*(-1._dp+4._dp*z**2))/(d2*z**5)+  &
...
1.9676465988144982e-1_dp*z**4)))/(r0*rz*(r0*rz-1._dp*z)*(1+r0*rz  &
-1._dp*z)*z**6))+l2*((4.372547997365551e-3_dp*l5*(-2._dp+r0/rz+  &
rz/r0)*(1-2._dp*z)*(1+2._dp*z)*(-1._dp+4._dp*z**2))/(d2*z**5)+  &
(8.745095994731102e-3_dp*l4*(2-(1._dp*r0)/rz-(1._dp*rz)/r0)*(1-  &
2._dp*z)*(1+2._dp*z)*(-1._dp+4._dp*z**2))/(z**5*(-1._dp-  &
2._dp*r0*rz+2._dp*z))+((-2._dp+r0/rz+  &
rz/r0)*(3.8259794976948562e-3_dp+1.311764399209665e-2_dp*r0*rz+  &
4.372547997365551e-3_dp*z+2.62352879841933e-2_dp*r0*z**1.5_dp-  &
2.62352879841933e-2_dp*z**2)*(-1._dp+4._dp*z**2))/(d2*z**5)+  &
...
3.9352931976289964e-1_dp*z**4)))/(r0*rz*(r0*rz-1._dp*z)*(1+r0*rz  &
-1._dp*z)*z**6)+l3*((4.372547997365551e-3_dp*(-2._dp+r0/rz+  &
rz/r0)*(1-4._dp*z**2)**2)/(d2*z**5)+  &
(rz**2*z*(4.372547997365551e-3_dp+8.745095994731102e-3_dp*z-  &
1.74901919894622e-2_dp*z**2-3.49803839789244e-2_dp*z**3)+  &
r0**2*(-3.498038397892442e-2_dp*(-0.5_dp+z)*z*(0.5_dp+z)**2+  &
rz**2*(-4.372547997365551e-2_dp-6.99607679578488e-2_dp*z+  &
1.0494115193677322e-1_dp*z**2+  &
1.3992153591569765e-1_dp*z**3)))/(r0*rz*z**6))))+  &
l1**2*((-3.143051358559554e2_dp*d2**2*(r0**2-2._dp*r0*rz+  &
rz**2)*(0.5_dp+r0*rz-1._dp*z)*(-1._dp+  &
z)*(-3.7913315126399993e-1_dp+z)*(1+z)*(rz+r0*(-0.5_dp+z)-  &
1._dp*z**1.5_dp))/(d1**4*r0*z**2)+  &
...
(3.702260139950978_dp*d2*(-2._dp+r0/rz+rz/r0)*(1-1._dp*z)**2*(1  &
+z))/z)/d1**2+(1.4757349491108736e-2_dp*(r0**2-2._dp*r0*rz+  &
rz**2)*(2.802528429206536e1_dp*r0*rz*z**3+  &
r0*rz**3*(1.4999999999999996_dp+z)+z**3*(8.174041251852396_dp+  &
...
2.666666666666666_dp*z**2+2._dp*r0*z**2.5_dp-  &
2._dp*z**3)))/(d2*rz**2*z**5)+(PL3*(-1.434742311635571e-2_dp+  &
3.4433815479253713e-2_dp*z**2-  &
2.62352879841933e-2_dp*z**2*(3._dp*r0*rz+z+6._dp*r0*z**1.5_dp-  &
6._dp*z**2)-1.6397054990120816e-2_dp*(3._dp*r0*rz+z+  &
6._dp*r0*z**1.5_dp-6._dp*z**2)*(1-4._dp*z**2)-  &
(2.62352879841933e-2_dp*(r0**2-2._dp*r0*rz+rz**2)*z*(2.5e-1_dp-  &
1._dp*z**2)**2)/(r0*rz*(r0*rz-1._dp*z))-  &
(5.24705759683866e-2_dp*(r0**2-2._dp*r0*rz+rz**2)*z*(2.5e-1_dp-  &
1._dp*z**2)**2)/(r0*rz*(1+r0*rz-1._dp*z))+  &
3.2794109980241624e-3_dp*z*(1-4._dp*z**2)*(1+(1.5_dp*r0)/rz+  &
9._dp*r0*rz-1.2e1_dp*z+(1.5_dp*rz+3._dp*z**1.5_dp)/r0)))/z**6+  &
(PL4*(-2.869484623271142e-2_dp+6.886763095850743e-2_dp*z**2-  &
5.24705759683866e-2_dp*z**2*(3._dp*r0*rz+z+6._dp*r0*z**1.5_dp-  &
6._dp*z**2)-3.2794109980241632e-2_dp*(3._dp*r0*rz+z+  &
6._dp*r0*z**1.5_dp-6._dp*z**2)*(1-4._dp*z**2)-  &
(5.24705759683866e-2_dp*(r0**2-2._dp*r0*rz+rz**2)*z*(2.5e-1_dp-  &
1._dp*z**2)**2)/(r0*rz*(r0*rz-1._dp*z))-  &
(1.049411519367732e-1_dp*(r0**2-2._dp*r0*rz+rz**2)*z*(2.5e-1_dp-  &
1._dp*z**2)**2)/(r0*rz*(1+r0*rz-1._dp*z))+  &
6.558821996048325e-3_dp*z*(1-4._dp*z**2)*(1+(1.5_dp*r0)/rz+  &
9._dp*r0*rz-1.2e1_dp*z+(1.5_dp*rz+3._dp*z**1.5_dp)/r0)))/z**6+  &
l5*((-1.399215359156976e-1_dp*PL1*(r0**2-2._dp*r0*rz+  &
rz**2)*(2.5e-1_dp-1._dp*z**2)**2)/(d2*r0*rz*z**5)-  &
(2.798430718313952e-1_dp*PL2*(r0**2-2._dp*r0*rz+rz**2)*(2.5e-1_dp-  &
1._dp*z**2)**2)/(d2*r0*rz*z**5)+(1.311764399209665e-2_dp*(r0**2-  &
2._dp*r0*rz+rz**2)*(0.5_dp+z)*(r0*rz**3+(2.802528429206536e1_dp-  &
5.605056858413072e1_dp*z)*z**3+rz**2*(1.791666666666667_dp-  &
1.666666666666667_dp*z+2._dp*r0*z**1.5_dp-  &
4._dp*z**2)))/(d2*rz**2*z**5))+  &
...
5.041922091690504e-1_dp*z**6)))/(r0*rz**2*(r0*rz-1._dp*z)*(1+  &
r0*rz-1._dp*z)*z**6)+l2**2*((-2.098823038735464e-1_dp*(r0**2-  &
2._dp*r0*rz+rz**2)*(0.5_dp+z)*(-2.5e-1_dp+z**2))/(d2*z**5)+  &
(6.99607679578488e-2_dp*rz**2*z*(0.5_dp+z)**2+  &
r0**2*(6.99607679578488e-2_dp*z*(0.5_dp+z)**2+  &
rz**2*(-8.745095994731102e-2_dp-2.798430718313952e-1_dp*z-  &
2.0988230387354645e-1_dp*z**2)))/z**6)+  &
l3**2*((-5.24705759683866e-2_dp*(r0**2-2._dp*r0*rz+rz**2)*(0.5_dp  &
+z)*(-2.5e-1_dp+z**2))/(d2*z**5)+  &
(1.74901919894622e-2_dp*rz**2*z*(0.5_dp+z)**2+  &
r0**2*(1.74901919894622e-2_dp*z*(0.5_dp+z)**2+  &
rz**2*(-2.1862739986827755e-2_dp-6.99607679578488e-2_dp*z-  &
5.247057596838661e-2_dp*z**2)))/z**6)+  &
l4*((-1.74901919894622e-2_dp*PL1*(2-(1._dp*r0)/rz-  &
(1._dp*rz)/r0)*(1-4._dp*z**2)**2)/(z**5*(-1._dp-2._dp*r0*rz+  &
2._dp*z))-(3.49803839789244e-2_dp*PL2*(2-(1._dp*r0)/rz-  &
(1._dp*rz)/r0)*(1-4._dp*z**2)**2)/(z**5*(-1._dp-2._dp*r0*rz+  &
2._dp*z))+(r0**3*rz**2*(rz*(6.558821996048325e-3_dp+  &
...
4.328822517391895e-1_dp*z**4)))/(r0*rz*(r0*rz-1._dp*z)*(1+r0*rz-  &
1._dp*z)*z**6))+PL2*(((-2._dp+r0/rz+rz/r0)*(1-2._dp*z)*(1+  &
2._dp*z)*(-1.147793849308457e-2_dp-3.935293197628995e-2_dp*r0*rz-  &
1.311764399209665e-2_dp*z-7.87058639525799e-2_dp*r0*z**1.5_dp+  &
7.87058639525799e-2_dp*z**2))/(d2*z**5)+  &
...
1.9434013328817377_dp*z**5)))/(r0*rz*(r0*rz-1._dp*z)*(0.5_dp+  &
r0*rz-1._dp*z)*(1+r0*rz-1._dp*z)*z**6))+  &
((1.2860626243191735e1_dp*d2**2*(-2._dp+r0/rz+rz/r0)*(1-  &
1._dp*z)**2)/z+(7.404520279901956_dp*d2**3*(-2._dp+r0/rz+  &
rz/r0)*(1-1._dp*z)**2*(1+z))/z+(5.238418930932589e1_dp*(r0**2-  &
2._dp*r0*rz+rz**2)*(0.5_dp+r0*rz-1._dp*z)*(-1._dp+  &
z)*(-3.7913315126399993e-1_dp+z)*(1+z)*(rz+r0*(-0.5_dp+z)-  &
1._dp*z**1.5_dp))/(r0*z**2)+  &
...
(7.87058639525799e-2_dp*(r0**2-2._dp*r0*rz+  &
rz**2)*(3.5031605365081706_dp*z**3-1.4012642146032683e1_dp*z**5+  &
r0*rz**3*(0.5_dp+z)+rz**2*(3.333333333333334e-1_dp+  &
5.833333333333334e-1_dp*z+r0*z**1.5_dp-1.4166666666666665_dp*z**2  &
+2._dp*r0*z**2.5_dp-2.5_dp*z**3)))/(d2*rz**2*z**5)+  &
(l5*(1.7490191989462198e-1_dp*r0**2*(-0.5_dp+z)*(0.5_dp+z)**2+  &
1.7490191989462198e-1_dp*rz**2*(-0.5_dp+z)*(0.5_dp+z)**2+  &
r0*rz*(4.37254799736555e-2_dp+8.7450959947311e-2_dp*z-  &
1.74901919894622e-1_dp*z**2-  &
3.49803839789244e-1_dp*z**3)))/(d2*z**5)+  &
(l4*(1.7490191989462198e-1_dp*r0**2*(-0.5_dp+z)*(0.5_dp+z)**2+  &
1.7490191989462198e-1_dp*rz**2*(-0.5_dp+z)*(0.5_dp+z)**2+  &
r0*rz*(4.37254799736555e-2_dp+8.7450959947311e-2_dp*z-  &
1.74901919894622e-1_dp*z**2-3.49803839789244e-1_dp*z**3)))/((0.5_dp  &
+r0*rz-1._dp*z)*z**5)+(rz**2*z*(-1.9710193142362198e-2_dp+  &
...
3.6762570212061196e-1_dp*z**5)))/(rz**2*(r0*rz-1._dp*z)*(1+r0*rz  &
-1._dp*z)*z**6)+l3*((-2.098823038735464e-1_dp*(r0**2-2._dp*r0*rz+  &
rz**2)*(0.5_dp+z)*(-2.5e-1_dp+z**2))/(d2*z**5)+  &
(6.99607679578488e-2_dp*rz**2*z*(0.5_dp+z)**2+  &
r0**2*(6.99607679578488e-2_dp*z*(0.5_dp+z)**2+  &
rz**2*(-8.745095994731102e-2_dp-2.798430718313952e-1_dp*z-  &
2.0988230387354645e-1_dp*z**2)))/z**6)+  &
...
(-8.745095994731102e-2_dp*rz**2*(-0.5_dp+z)*z*(0.5_dp+z)**2+  &
r0**2*(-8.745095994731102e-2_dp*(-0.5_dp+z)*z*(0.5_dp+z)**2+  &
...
PL2*((-2.62352879841933e-2_dp*(-2._dp+r0/rz+rz/r0)*(1-2._dp*z)*(1  &
+2._dp*z)*(-1._dp+4._dp*z**2))/(d2*z**5)+  &
...
1.7490191989462198e-1_dp*rz**2*(-0.5_dp+z)*(0.5_dp+z)**2)+  &
r0**3*rz*(-1.7490191989462198e-1_dp*(-0.5_dp+z)*z*(0.5_dp+z)**2+  &
...
1._dp*z)*z**6)))+l3*((l5*(8.745095994731102e-2_dp*r0**2-  &
1.7490191989462198e-1_dp*r0*rz+  &
8.745095994731102e-2_dp*rz**2)*(-0.5_dp+z)*(0.5_dp+  &
z)**2)/(d2*z**5)+(l4*(8.745095994731102e-2_dp*r0**2-  &
1.7490191989462198e-1_dp*r0*rz+  &
8.745095994731102e-2_dp*rz**2)*(-0.5_dp+z)*(0.5_dp+z)**2)/((0.5_dp  &
+r0*rz-1._dp*z)*z**5)+(PL3*(1.6397054990120816e-2_dp-  &
...
1.8381285106030598e-1_dp*z**5)))/(rz**2*(r0*rz-1._dp*z)*(1+r0*rz  &
-1._dp*z)*z**6)+PL1*((r0*rz*(-6.558821996048325e-3_dp+  &
5.24705759683866e-2_dp*z**2-1.049411519367732e-1_dp*z**4)+  &
...
r0**2*(-4.372547997365551e-2_dp*(-0.5_dp+z)*z*(0.5_dp+z)**2+  &
...
5.24705759683866e-2_dp*z**2+1.049411519367732e-1_dp*z**4-  &
8.745095994731102e-2_dp*rz**2*(-0.5_dp+z)*(0.5_dp+z)**2)+  &
r0**3*rz*(-8.745095994731102e-2_dp*(-0.5_dp+z)*z*(0.5_dp+z)**2+  &
rz**2*(-1.0931369993413877e-1_dp-1.7490191989462203e-1_dp*z+  &
...
complex (dp) function P2(z)
  ...
  1._dp*rz*z**9))/(rz*(1-4*(0.5_dp+r1*rz-1._dp*z)**2)**3*z**5)  &

...
complex (dp) function P2Der(z)
  ...
  PL3 = cli3(d2); PL4 = cli3(-d2); l4 = Log(1 + d2); l5 = Log(2 * z - 2 * r0 * rz)
  ...
  (2.6854661544532146_dp*(r0**2-2*r0*rz+rz**2)*(-1+  &
...
2*r0*rz+rz**2)*(-5.e-1_dp+z)*(5.e-1_dp+z)**2)/(d2*z**5)+((1+  &
2*z)*(6.99607679578488e-2_dp*r0**2*rz**2*z-  &
1.7490191989462203e-1_dp*r0**2*rz**2*(5.e-1_dp+z)+  &
3.49803839789244e-2_dp*r0**2*z*(5.e-1_dp+z)+  &
3.49803839789244e-2_dp*rz**2*z*(5.e-1_dp+z)+  &
(1.049411519367732e-1_dp*(r0**2-2*r0*rz+rz**2)*z*(-2.5e-1_dp+  &
z**2))/(5.e-1_dp+r0*rz-1*z)))/z**6)+  &
...
rz**2)*(5.e-1_dp+z)**2)/(d2*z**5)+  &
(6.99607679578488e-2_dp*PL2*r0*rz*(r0**2-2*r0*rz+  &
rz**2)*(5.e-1_dp+z)**2)/(d2*z**5)+  &
(1.049411519367732e-1_dp*PL3*(r0**2-2*r0*rz+rz**2)*(5.e-1_dp+  &
z)*(-2.5e-1_dp+z**2))/(d2*z**5)+  &
(2.098823038735464e-1_dp*PL4*(r0**2-2*r0*rz+rz**2)*(5.e-1_dp+  &
...
rz**2)*(5.e-1_dp+z)**2)/((5.e-1_dp+r0*rz-1*z)*z**5)-  &
(6.99607679578488e-2_dp*PL2*r0*rz*(r0**2-2*r0*rz+  &
rz**2)*(5.e-1_dp+z)**2)/((5.e-1_dp+r0*rz-1*z)*z**5)-  &
(1.049411519367732e-1_dp*PL3*(r0**2-2*r0*rz+rz**2)*(5.e-1_dp+  &
z)*(-2.5e-1_dp+z**2))/((5.e-1_dp+r0*rz-1*z)*z**5)-  &
(2.098823038735464e-1_dp*PL4*(r0**2-2*r0*rz+rz**2)*(5.e-1_dp+  &
z)*(-2.5e-1_dp+z**2))/((5.e-1_dp+r0*rz-1*z)*z**5)+  &
(r0**2*(7.884077256944878e-3_dp+2.9978935505327797e-2_dp*z+  &
2.3509379518035014e-3_dp*z**2-1.7295897377329486e-1_dp*z**3-  &
...
4.832709028445988e-1_dp*z**4))/((5.e-1_dp+r0*rz-1*z)*z**5))+  &
l2*((6.99607679578488e-2_dp*PL1*r0*rz*(r0**2-2*r0*rz+  &
rz**2)*(5.e-1_dp+z)**2)/(d2*z**5)+  &
(1.399215359156976e-1_dp*PL2*r0*rz*(r0**2-2*r0*rz+  &
rz**2)*(5.e-1_dp+z)**2)/(d2*z**5)+  &
(2.098823038735464e-1_dp*PL3*(r0**2-2*r0*rz+rz**2)*(5.e-1_dp+  &
z)*(-2.5e-1_dp+z**2))/(d2*z**5)+  &
(4.197646077470928e-1_dp*PL4*(r0**2-2*r0*rz+rz**2)*(5.e-1_dp+  &
...
3.459179475465897e-1_dp*z**3+  &
4.832709028445988e-1_dp*z**4))/(d2*z**5))+  &
PL1**2*((-6.996076795784882e-2_dp*r0*rz*(-5.e-1_dp+z)*(5.e-1_dp+z)**2  &
...
(1.74901919894622e-2_dp*rz**2*z*(5.e-1_dp+z)**2+  &
r0**2*(1.74901919894622e-2_dp*z*(5.e-1_dp+z)**2+  &
...
PL3*((-2.62352879841933e-2_dp*(-2+r0/rz+rz/r0)*(1-2*z)*(1  &
+2*z)*(1-4*z**2))/(d2*z**5)+  &
(4.197646077470928e-1_dp*r0*rz*z**2*(5.e-1_dp+z)+  &
(3.9352931976289964e-2_dp*(2-(1*r0)/rz-(1*rz)/r0)*z*(1-  &
4*z**2)**2)/(-1-2*r0*rz+2*z)+  &
2.098823038735464e-1_dp*r0*rz*z*(-2.5e-1_dp+z**2)-  &
1.0494115193677322_dp*r0*rz*(5.e-1_dp+z)*(-2.5e-1_dp+z**2)+  &
(1.049411519367732e-1_dp*r0*z*(5.e-1_dp+z)*(-2.5e-1_dp+z**2))/rz+  &
(1.049411519367732e-1_dp*rz*z*(5.e-1_dp+z)*(-2.5e-1_dp+  &
z**2))/r0)/z**6)+PL4*((-5.24705759683866e-2_dp*(-2+r0/rz+  &
rz/r0)*(1-2*z)*(1+2*z)*(1-4*z**2))/(d2*z**5)+  &
(8.395292154941856e-1_dp*r0*rz*z**2*(5.e-1_dp+z)+  &
(7.870586395257993e-2_dp*(2-(1*r0)/rz-(1*rz)/r0)*z*(1-  &
4*z**2)**2)/(-1-2*r0*rz+2*z)+  &
4.197646077470928e-1_dp*r0*rz*z*(-2.5e-1_dp+z**2)-  &
2.0988230387354645_dp*r0*rz*(5.e-1_dp+z)*(-2.5e-1_dp+z**2)+  &
(2.098823038735464e-1_dp*r0*z*(5.e-1_dp+z)*(-2.5e-1_dp+z**2))/rz+  &
(2.098823038735464e-1_dp*rz*z*(5.e-1_dp+z)*(-2.5e-1_dp+  &
...
4.83270902844599e-1_dp*z**5)))/(r0*rz*(5.e-1_dp+r0*rz-  &
1*z)*z**6))+l1**4*((l2**2*(-5.465684996706939e-3_dp+  &
...
6*r0*z**1.5_dp-6*z**2)**2+(9.56494874423714e-4_dp*(-1+  &
(5.e-1_dp*r0)/rz+(5.e-1_dp*rz)/r0)*z*(-1+4*z**2))/(1+r0*rz-  &
1*z)+(4.78247437211857e-4_dp*(8-(4*r0)/rz-  &
(4*rz)/r0)*z*(-1+4*z**2))/(-8*r0*rz+8*z)+  &
(1.0931369993413877e-3_dp*(-1+(5.e-1_dp*r0)/rz+  &
(5.e-1_dp*rz)/r0)*z*(3*r0*rz+z+6*r0*z**1.5_dp-  &
6*z**2)*(-1+4*z**2))/(1+r0*rz-1*z)+  &
(5.465684996706938e-4_dp*(8-(4*r0)/rz-  &
(4*rz)/r0)*z*(3*r0*rz+z+6*r0*z**1.5_dp-  &
6*z**2)*(-1+4*z**2))/(-8*r0*rz+8*z)+  &
...
6*z**2)+(1.0931369993413877e-3_dp*(-1+(5.e-1_dp*r0)/rz+  &
(5.e-1_dp*rz)/r0)*z*(1-4*z**2)**2)/(1+r0*rz-1*z)+  &
(5.465684996706938e-4_dp*(8-(4*r0)/rz-(4*rz)/r0)*z*(1-  &
4*z**2)**2)/(-8*r0*rz+8*z)-  &
2.7328424983534694e-3_dp*(3*r0*rz+z+6*r0*z**1.5_dp-  &
6*z**2)*(-1+4*z**2)+5.465684996706938e-4_dp*z*(-1+  &
...
6*z**2)+(2.1862739986827755e-3_dp*(-1+(5.e-1_dp*r0)/rz+  &
(5.e-1_dp*rz)/r0)*z*(1-4*z**2)**2)/(1+r0*rz-1*z)+  &
(1.0931369993413877e-3_dp*(8-(4*r0)/rz-(4*rz)/r0)*z*(1  &
-4*z**2)**2)/(-8*r0*rz+8*z)-  &
5.465684996706939e-3_dp*(3*r0*rz+z+6*r0*z**1.5_dp-  &
6*z**2)*(-1+4*z**2)+1.0931369993413877e-3_dp*z*(-1+  &
4*z**2)*(1+(1.5_dp*r0)/rz+9*r0*rz-1.2e1_dp*z+(1.5_dp*rz+  &
3*z**1.5_dp)/r0))/z**6))+  &
...
6.996076795784882e-2_dp*rz**2)*(-5.e-1_dp+z)*(5.e-1_dp+  &
z)**2)/(d2*z**5)+((1+  &
2*z)*(6.99607679578488e-2_dp*r0**2*rz**2*z-  &
1.7490191989462203e-1_dp*r0**2*rz**2*(5.e-1_dp+z)+  &
3.49803839789244e-2_dp*r0**2*z*(5.e-1_dp+z)+  &
...
(1.0494115193677322e-1_dp*rz**2*(-5.e-1_dp+z)*z*(5.e-1_dp+z)**2+  &
r0**2*(1.0494115193677322e-1_dp*(-5.e-1_dp+z)*z*(5.e-1_dp+z)**2+  &
...
(5.24705759683866e-2_dp*rz**2*(-5.e-1_dp+z)*z*(5.e-1_dp+z)**2+  &
r0**2*(5.24705759683866e-2_dp*(-5.e-1_dp+z)*z*(5.e-1_dp+z)**2+  &
...
rz**2)*(5.e-1_dp+z)**2)/(d2*z**5)+(1.0476837861865178q2*(r0**2-  &
2*r0*rz+rz**2)*(5.e-1_dp+r0*rz-1*z)*(-1+  &
z)*(-3.7913315126399993e-1_dp+z)*(1+z)*(rz+r0*(-5.e-1_dp+z)-  &
1*z**1.5_dp))/(d1**3*r0*z**2)+  &
((-3.702260139950978_dp*d2*(-2+r0/rz+rz/r0)*(1-  &
1*z)**2*(1+z))/z-(5.370932308906429_dp*d2**2*(r0**2-  &
2*r0*rz+rz**2)*(-1+z)*(1.0647869616635923_dp+  &
...
rz**2)*(2.5e-1_dp-1*z**2)**2)/(d2*r0*rz*z**5)+((1+  &
2*z)*(-2.798430718313952e-1_dp*r0*rz*(-5.e-1_dp+z)*z-  &
1.399215359156976e-1_dp*r0*rz*z*(5.e-1_dp+z)-  &
(5.24705759683866e-2_dp*(2-(1*r0)/rz-(1*rz)/r0)*(1-  &
2*z)*z*(1-4*z**2))/(-1-2*r0*rz+2*z)+  &
...
8.155196485502605e-1_dp*z**5)))/(r0*rz*(r0*rz-1*z)*(1+r0*rz-  &
1*z)*z**6)+l5*((1.399215359156976e-1_dp*PL1*(r0**2-  &
2*r0*rz+rz**2)*(-5.e-1_dp+z)*(5.e-1_dp+z)**2)/(d2*z**5)+  &
(2.798430718313952e-1_dp*PL2*(r0**2-2*r0*rz+rz**2)*(-5.e-1_dp+  &
z)*(5.e-1_dp+z)**2)/(d2*z**5)+(1.311764399209665e-2_dp*PL3*(-2+  &
r0/rz+rz/r0)*(1-2*z)*(1+2*z)*(1-4*z**2))/(d2*z**5)+  &
(2.62352879841933e-2_dp*PL4*(-2+r0/rz+rz/r0)*(1-2*z)*(1+  &
2*z)*(1-4*z**2))/(d2*z**5)+  &
...
rz**2)*(-5.e-1_dp+z)*(5.e-1_dp+z)**2)/((5.e-1_dp+r0*rz-1*z)*z**5)+  &
(2.798430718313952e-1_dp*PL2*(r0**2-2*r0*rz+rz**2)*(-5.e-1_dp+  &
z)*(5.e-1_dp+z)**2)/((5.e-1_dp+r0*rz-1*z)*z**5)+  &
(2.62352879841933e-2_dp*PL3*(2-(1*r0)/rz-(1*rz)/r0)*(1-  &
2*z)*(1+2*z)*(1-4*z**2))/(z**5*(-1-2*r0*rz+  &
2*z))+(5.24705759683866e-2_dp*PL4*(2-(1*r0)/rz-  &
(1*rz)/r0)*(1-2*z)*(1+2*z)*(1-  &
4*z**2))/(z**5*(-1-2*r0*rz+2*z))+  &
(r0*rz*(-1.5768154513889756e-2_dp-2.842156198287608e-2_dp*z+  &
1.152138661177042e-1_dp*z**2+3.5532169935380375e-1_dp*z**3-  &
2.085649922485806e-1_dp*z**4-9.665418056891976e-1_dp*z**5)+  &
rz**2*(7.884077256944878e-3_dp+1.421078099143804e-2_dp*z-  &
...
4.832709028445988e-1_dp*z**5+rz**4*(9.83823299407249e-3_dp+  &
2.623528798419331e-2_dp*z+  &
1.311764399209665e-2_dp*z**2)))/(r0*rz*(5.e-1_dp+r0*rz-  &
1*z)*z**5))+PL1**2*((r0**2*(-4.372547997365551e-3_dp+  &
...
1.74901919894622e-2_dp*z**2-3.49803839789244e-2_dp*z**3)+  &
r0**2*(-3.498038397892442e-2_dp*(-5.e-1_dp+z)*z*(5.e-1_dp+z)**2+  &
rz**2*(-4.372547997365551e-2_dp-6.99607679578488e-2_dp*z+  &
1.0494115193677322e-1_dp*z**2+  &
1.3992153591569765e-1_dp*z**3)))/(r0*rz*z**6))+PL3*(((-2+  &
...
3.9352931976289964e-1_dp*z**4)))/(r0*rz*(r0*rz-1*z)*(1+r0*rz  &
-1*z)*z**6))+PL4*(((-2+r0/rz+rz/r0)*(1-  &
...
7.870586395257993e-1_dp*z**4)))/(r0*rz*(r0*rz-1*z)*(1+r0*rz-  &
1*z)*z**6))+PL1*((PL3*(6.5588219960483265e-2_dp-  &
...
2*z)*(-2.798430718313952e-1_dp*r0*rz*(-5.e-1_dp+z)*z-  &
1.399215359156976e-1_dp*r0*rz*z*(5.e-1_dp+z)-  &
(2.62352879841933e-2_dp*(2-(1*r0)/rz-(1*rz)/r0)*(1-  &
2*z)*z*(1-4*z**2))/(-1-2*r0*rz+2*z)+  &
r0*rz*(-1.7490191989462203e-1_dp+6.996076795784881e-1_dp*z**2)+  &
(1.74901919894622e-2_dp*r0*z-6.99607679578488e-2_dp*r0*z**3)/rz+  &
(1.74901919894622e-2_dp*rz*z-  &
...
1.838128510603061e-1_dp*z**5)))/(rz**2*(r0*rz-1*z)*(1+r0*rz-  &
1*z)*z**6))+PL2*((PL3*(1.3117643992096653e-1_dp-  &
...
2*r0*rz+rz**2)*(5.e-1_dp+z)*(r0*rz**3+(2.802528429206536e1_dp-  &
...
1.1028771063618361_dp*z**7)))/(rz**2*(r0*rz-1*z)*(5.e-1_dp+  &
r0*rz-1*z)*(1+r0*rz-1*z)*z**6))+  &
...
6.996076795784881e-1_dp*rz**2)*(-5.e-1_dp+z)*(5.e-1_dp+  &
z)**2)/(d2*z**5)+((1+  &
2*z)*(1.399215359156976e-1_dp*r0**2*rz**2*z-  &
3.4980383978924405e-1_dp*r0**2*rz**2*(5.e-1_dp+z)+  &
6.99607679578488e-2_dp*r0**2*z*(5.e-1_dp+z)+  &
6.99607679578488e-2_dp*rz**2*z*(5.e-1_dp+z)+  &
(1.049411519367732e-1_dp*(r0**2-2*r0*rz+rz**2)*z*(-2.5e-1_dp+  &
z**2))/(5.e-1_dp+r0*rz-1*z)))/z**6)-  &
...
1.3992153591569765e-1_dp*rz**2)*(-5.e-1_dp+z)*(5.e-1_dp+  &
z)**2)/(d2*z**5)+(6.99607679578488e-2_dp*rz**2*z*(5.e-1_dp+z)**2+  &
r0**2*(6.99607679578488e-2_dp*z*(5.e-1_dp+z)**2+  &
...
-1*z**2)**2)/(d2*r0*rz*z**5)+  &
(2.098823038735464e-1_dp*rz**2*(-5.e-1_dp+z)*z*(5.e-1_dp+z)**2+  &
r0**2*(2.098823038735464e-1_dp*(-5.e-1_dp+z)*z*(5.e-1_dp+z)**2+  &
...
(5.24705759683866e-2_dp*(r0**2-2*r0*rz+rz**2)*z*(-2.5e-1_dp+  &
z**2))/(5.e-1_dp+r0*rz-1*z)))/z**6+  &
(6.996076795784881e-1_dp*r0*rz*(-5.e-1_dp+z)*(5.e-1_dp+z)**2+  &
...
1.3992153591569765e-1_dp*r0*rz-  &
6.996076795784882e-2_dp*rz**2)*(-5.e-1_dp+z)*(5.e-1_dp+  &
z)**2)/(d2*z**5)+(3.49803839789244e-2_dp*rz**2*z*(5.e-1_dp+z)**2+  &
r0**2*(3.49803839789244e-2_dp*z*(5.e-1_dp+z)**2+  &
...
+(1.2860626243191735e1_dp*d2**2*(-2+r0/rz+rz/r0)*(1-  &
1*z)**2)/z)/d1**3-(2.572125248638347e1_dp*d2**4*(-2+r0/rz  &
+rz/r0)*(1-1*z)**2)/(d1**4*z)+(l4*(2-(1*r0)/rz-  &
(1*rz)/r0)*(1-2*z)*(1+2*z)*(3.8259794976948562e-3_dp+  &
1.311764399209665e-2_dp*r0*rz+4.372547997365551e-3_dp*z+  &
2.62352879841933e-2_dp*r0*z**1.5_dp-  &
2.62352879841933e-2_dp*z**2))/(z**5*(-1-2*r0*rz+2*z))+  &
(l5*(-2+r0/rz+rz/r0)*(1-2*z)*(1+  &
2*z)*(1.9129897488474281e-3_dp+6.558821996048325e-3_dp*r0*rz+  &
2.1862739986827755e-3_dp*z+1.311764399209665e-2_dp*r0*z**1.5_dp-  &
1.311764399209665e-2_dp*z**2))/(d2*z**5)+((-2+r0/rz+  &
...
1.5303917990779425e-2_dp*(-5.e-1_dp+z)*z-  &
7.6519589953897125e-2_dp*z**2+1.5303917990779425e-2_dp*z*(5.e-1_dp+z)  &
...
6*r0*z**1.5_dp-6*z**2)-(8.745095994731102e-3_dp*(-1+  &
(5.e-1_dp*r0)/rz+(5.e-1_dp*rz)/r0)*(1-2*z)*z*(1+2*z)*(-1+  &
4*z**2))/(1+r0*rz-1*z)-(4.372547997365551e-3_dp*(8-  &
(4*r0)/rz-(4*rz)/r0)*(1-2*z)*z*(1+2*z)*(-1+  &
4*z**2))/(-8*r0*rz+8*z)-4.372547997365551e-3_dp*(1-  &
2*z)*z*(1+2*z)*(1+(1.5_dp*r0)/rz+9*r0*rz-1.2e1_dp*z+  &
(1.5_dp*rz+3*z**1.5_dp)/r0)))/z**6+  &
(PL1*(9.56494874423714e-3_dp+7.6519589953897125e-3_dp*(-5.e-1_dp+z)*z  &
-3.8259794976948562e-2_dp*z**2+7.6519589953897125e-3_dp*z*(5.e-1_dp+  &
z)-4.372547997365551e-3_dp*(1-2*z)*z*(3*r0*rz+z+  &
6*r0*z**1.5_dp-6*z**2)+1.0931369993413877e-2_dp*(1-  &
2*z)*(1+2*z)*(3*r0*rz+z+6*r0*z**1.5_dp-6*z**2)  &
+4.372547997365551e-3_dp*z*(1+2*z)*(3*r0*rz+z+  &
6*r0*z**1.5_dp-6*z**2)-(4.372547997365551e-3_dp*(-1+  &
(5.e-1_dp*r0)/rz+(5.e-1_dp*rz)/r0)*(1-2*z)*z*(1+2*z)*(-1+  &
4*z**2))/(1+r0*rz-1*z)-(2.1862739986827755e-3_dp*(8-  &
(4*r0)/rz-(4*rz)/r0)*(1-2*z)*z*(1+2*z)*(-1+  &
...
5.514385531809179e-1_dp*z**5)))/(r0*rz**2*(r0*rz-1*z)*(1+  &
r0*rz-1*z)*z**6)+l3**2*((1.0931369993413877e-3_dp*(-2+  &
r0/rz+rz/r0)*(1-4*z**2)**2)/(d2*z**5)+  &
(-8.745095994731102e-3_dp*rz**2*(-5.e-1_dp+z)*z*(5.e-1_dp+z)**2+  &
r0**2*(-8.745095994731102e-3_dp*(-5.e-1_dp+z)*z*(5.e-1_dp+z)**2+  &
rz**2*(-1.0931369993413877e-2_dp-1.74901919894622e-2_dp*z+  &
2.6235287984193305e-2_dp*z**2+  &
3.498038397892441e-2_dp*z**3)))/(r0*rz*z**6))+  &
l2**2*((4.372547997365551e-3_dp*(-2+r0/rz+rz/r0)*(1-  &
...
l3*((2.1862739986827755e-3_dp*l5*(-2+r0/rz+rz/r0)*(1-  &
2*z)*(1+2*z)*(-1+4*z**2))/(d2*z**5)+  &
(4.372547997365551e-3_dp*l4*(2-(1*r0)/rz-(1*rz)/r0)*(1-  &
2*z)*(1+2*z)*(-1+4*z**2))/(z**5*(-1-  &
2*r0*rz+2*z))+((-2+r0/rz+  &
rz/r0)*(1.9129897488474281e-3_dp+6.558821996048325e-3_dp*r0*rz+  &
2.1862739986827755e-3_dp*z+1.311764399209665e-2_dp*r0*z**1.5_dp-  &
1.311764399209665e-2_dp*z**2)*(-1+4*z**2))/(d2*z**5)+  &
...
1.9676465988144982e-1_dp*z**4)))/(r0*rz*(r0*rz-1*z)*(1+r0*rz  &
-1*z)*z**6))+l2*((4.372547997365551e-3_dp*l5*(-2+r0/rz+  &
rz/r0)*(1-2*z)*(1+2*z)*(-1+4*z**2))/(d2*z**5)+  &
(8.745095994731102e-3_dp*l4*(2-(1*r0)/rz-(1*rz)/r0)*(1-  &
2*z)*(1+2*z)*(-1+4*z**2))/(z**5*(-1-  &
2*r0*rz+2*z))+((-2+r0/rz+  &
rz/r0)*(3.8259794976948562e-3_dp+1.311764399209665e-2_dp*r0*rz+  &
4.372547997365551e-3_dp*z+2.62352879841933e-2_dp*r0*z**1.5_dp-  &
2.62352879841933e-2_dp*z**2)*(-1+4*z**2))/(d2*z**5)+  &
...
3.9352931976289964e-1_dp*z**4)))/(r0*rz*(r0*rz-1*z)*(1+r0*rz  &
-1*z)*z**6)+l3*((4.372547997365551e-3_dp*(-2+r0/rz+  &
...
1.0494115193677322e-1_dp*z**2+  &
1.3992153591569765e-1_dp*z**3)))/(r0*rz*z**6))))+  &
l1**2*((-3.143051358559554q2*d2**2*(r0**2-2*r0*rz+  &
rz**2)*(5.e-1_dp+r0*rz-1*z)*(-1+  &
z)*(-3.7913315126399993e-1_dp+z)*(1+z)*(rz+r0*(-5.e-1_dp+z)-  &
1*z**1.5_dp))/(d1**4*r0*z**2)+  &
...
(3.702260139950978_dp*d2*(-2+r0/rz+rz/r0)*(1-1*z)**2*(1  &
...
1*z**2)**2)/(r0*rz*(r0*rz-1*z))-  &
(5.24705759683866e-2_dp*(r0**2-2*r0*rz+rz**2)*z*(2.5e-1_dp-  &
1*z**2)**2)/(r0*rz*(1+r0*rz-1*z))+  &
...
rz**2)*(2.5e-1_dp-1*z**2)**2)/(d2*r0*rz*z**5)-  &
(2.798430718313952e-1_dp*PL2*(r0**2-2*r0*rz+rz**2)*(2.5e-1_dp-  &
1*z**2)**2)/(d2*r0*rz*z**5)+(1.311764399209665e-2_dp*(r0**2-  &
2*r0*rz+rz**2)*(5.e-1_dp+z)*(r0*rz**3+(2.802528429206536e1_dp-  &
5.605056858413072e1_dp*z)*z**3+rz**2*(1.791666666666667_dp-  &
1.666666666666667_dp*z+2*r0*z**1.5_dp-  &
4*z**2)))/(d2*rz**2*z**5))+  &
...
5.041922091690504e-1_dp*z**6)))/(r0*rz**2*(r0*rz-1*z)*(1+  &
r0*rz-1*z)*z**6)+l2**2*((-2.098823038735464e-1_dp*(r0**2-  &
2*r0*rz+rz**2)*(5.e-1_dp+z)*(-2.5e-1_dp+z**2))/(d2*z**5)+  &
(6.99607679578488e-2_dp*rz**2*z*(5.e-1_dp+z)**2+  &
r0**2*(6.99607679578488e-2_dp*z*(5.e-1_dp+z)**2+  &
rz**2*(-8.745095994731102e-2_dp-2.798430718313952e-1_dp*z-  &
2.0988230387354645e-1_dp*z**2)))/z**6)+  &
l3**2*((-5.24705759683866e-2_dp*(r0**2-2*r0*rz+rz**2)*(5.e-1_dp  &
+z)*(-2.5e-1_dp+z**2))/(d2*z**5)+  &
(1.74901919894622e-2_dp*rz**2*z*(5.e-1_dp+z)**2+  &
r0**2*(1.74901919894622e-2_dp*z*(5.e-1_dp+z)**2+  &
rz**2*(-2.1862739986827755e-2_dp-6.99607679578488e-2_dp*z-  &
5.247057596838661e-2_dp*z**2)))/z**6)+  &
l4*((-1.74901919894622e-2_dp*PL1*(2-(1*r0)/rz-  &
(1*rz)/r0)*(1-4*z**2)**2)/(z**5*(-1-2*r0*rz+  &
2*z))-(3.49803839789244e-2_dp*PL2*(2-(1*r0)/rz-  &
(1*rz)/r0)*(1-4*z**2)**2)/(z**5*(-1-2*r0*rz+  &
...
1.049411519367732e-1_dp*z**3)))/(rz**2*(5.e-1_dp+r0*rz-  &
1*z)*z**5))+PL1*((PL2*(-8.745095994731102e-2_dp+  &
...
2*z**4+r0*(rz*(-2.5e-1_dp+z**2)+z**1.5_dp*(-5.e-1_dp+  &
2*z**2))))/(d2*r0*rz*z**5)+  &
...
4.328822517391895e-1_dp*z**4)))/(r0*rz*(r0*rz-1*z)*(1+r0*rz-  &
1*z)*z**6))+PL2*(((-2+r0/rz+rz/r0)*(1-2*z)*(1+  &
...
1.9434013328817377_dp*z**5)))/(r0*rz*(r0*rz-1*z)*(5.e-1_dp+  &
r0*rz-1*z)*(1+r0*rz-1*z)*z**6))+  &
((1.2860626243191735e1_dp*d2**2*(-2+r0/rz+rz/r0)*(1-  &
1*z)**2)/z+(7.404520279901956_dp*d2**3*(-2+r0/rz+  &
rz/r0)*(1-1*z)**2*(1+z))/z+(5.238418930932589e1_dp*(r0**2-  &
2*r0*rz+rz**2)*(5.e-1_dp+r0*rz-1*z)*(-1+  &
z)*(-3.7913315126399993e-1_dp+z)*(1+z)*(rz+r0*(-5.e-1_dp+z)-  &
1*z**1.5_dp))/(r0*z**2)+  &
...
2.2306582812115q2*z**4-1.5715256792797763q2*z**5)+  &
...
4.6052677423917645e1_dp*z**3+1.0476837861865178q2*z**4)+  &
rz**3*(-1.9860582769254662e1_dp+2.122694896234928e1_dp*z+  &
1.15131693559794q2*z**2-6.008206738782878e1_dp*z**3-  &
2.1990007217844583q2*z**4+  &
1.309604732733147q2*z**5))))/(r0*rz*z**3))/d1**3+  &
...
r0*rz**3*(5.e-1_dp+z)+rz**2*(3.333333333333334e-1_dp+  &
5.833333333333334e-1_dp*z+r0*z**1.5_dp-1.4166666666666665_dp*z**2  &
+2*r0*z**2.5_dp-2.5_dp*z**3)))/(d2*rz**2*z**5)+  &
(l5*(1.7490191989462198e-1_dp*r0**2*(-5.e-1_dp+z)*(5.e-1_dp+z)**2+  &
1.7490191989462198e-1_dp*rz**2*(-5.e-1_dp+z)*(5.e-1_dp+z)**2+  &
r0*rz*(4.37254799736555e-2_dp+8.7450959947311e-2_dp*z-  &
1.74901919894622e-1_dp*z**2-  &
3.49803839789244e-1_dp*z**3)))/(d2*z**5)+  &
(l4*(1.7490191989462198e-1_dp*r0**2*(-5.e-1_dp+z)*(5.e-1_dp+z)**2+  &
1.7490191989462198e-1_dp*rz**2*(-5.e-1_dp+z)*(5.e-1_dp+z)**2+  &
r0*rz*(4.37254799736555e-2_dp+8.7450959947311e-2_dp*z-  &
1.74901919894622e-1_dp*z**2-3.49803839789244e-1_dp*z**3)))/((5.e-1_dp  &
+r0*rz-1*z)*z**5)+(rz**2*z*(-1.9710193142362198e-2_dp+  &
...
3.6762570212061196e-1_dp*z**5)))/(rz**2*(r0*rz-1*z)*(1+r0*rz  &
-1*z)*z**6)+l3*((-2.098823038735464e-1_dp*(r0**2-2*r0*rz+  &
rz**2)*(5.e-1_dp+z)*(-2.5e-1_dp+z**2))/(d2*z**5)+  &
(6.99607679578488e-2_dp*rz**2*z*(5.e-1_dp+z)**2+  &
r0**2*(6.99607679578488e-2_dp*z*(5.e-1_dp+z)**2+  &
rz**2*(-8.745095994731102e-2_dp-2.798430718313952e-1_dp*z-  &
2.0988230387354645e-1_dp*z**2)))/z**6)+  &
...
(-8.745095994731102e-2_dp*rz**2*(-5.e-1_dp+z)*z*(5.e-1_dp+z)**2+  &
r0**2*(-8.745095994731102e-2_dp*(-5.e-1_dp+z)*z*(5.e-1_dp+z)**2+  &
...
PL2*((-2.62352879841933e-2_dp*(-2+r0/rz+rz/r0)*(1-2*z)*(1  &
+2*z)*(-1+4*z**2))/(d2*z**5)+  &
...
1.7490191989462198e-1_dp*rz**2*(-5.e-1_dp+z)*(5.e-1_dp+z)**2)+  &
r0**3*rz*(-1.7490191989462198e-1_dp*(-5.e-1_dp+z)*z*(5.e-1_dp+z)**2+  &
...
6.996076795784882e-1_dp*z**4)))/(r0*rz*(5.e-1_dp+r0*rz-  &
1*z)*z**6)))+l3*((l5*(8.745095994731102e-2_dp*r0**2-  &
1.7490191989462198e-1_dp*r0*rz+  &
8.745095994731102e-2_dp*rz**2)*(-5.e-1_dp+z)*(5.e-1_dp+  &
z)**2)/(d2*z**5)+(l4*(8.745095994731102e-2_dp*r0**2-  &
1.7490191989462198e-1_dp*r0*rz+  &
8.745095994731102e-2_dp*rz**2)*(-5.e-1_dp+z)*(5.e-1_dp+z)**2)/((5.e-1_dp  &
+r0*rz-1*z)*z**5)+(PL3*(1.6397054990120816e-2_dp-  &
...
1.8381285106030598e-1_dp*z**5)))/(rz**2*(r0*rz-1*z)*(1+r0*rz  &
-1*z)*z**6)+PL1*((r0*rz*(-6.558821996048325e-3_dp+  &
5.24705759683866e-2_dp*z**2-1.049411519367732e-1_dp*z**4)+  &
...
3.498038397892441e-1_dp*z**4)))/(r0*rz*(5.e-1_dp+r0*rz-  &
1*z)*z**6))))

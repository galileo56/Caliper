...
!ccccccccccccccc
  ...
  pure real (dp) function DeltaCharmBin(self, alpha, mb, mc)
    ...
    if (self%n == 1) then
      ...
      if (self%l == 0) then
        DeltaCharm = - 3 * Pi * r/2 + 9 * r**2/2 - 2 * Pi * r**3 + 3 * r**4/16 &

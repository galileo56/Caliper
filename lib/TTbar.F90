...
! ccccccccccc
  ...
  contains
    ...
    SigmaMatchedRad, SigmaMatched, SigmaMatchedRadCone, SigmaMatchedRadCum,  &
    SigmaMatchedRadConeCum
...
! ccccccccccc
  ...
  end function SigmaMatchedRadCum
...
! ccccccccccc
  ...
  end function SigmaMatchedRadConeCum

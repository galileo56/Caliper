...
# line 2489 "/Users/vicent/GitHub/Caliper/src/Caliper.tm"
#include "mathlink.h"
#include "ftypes.h"
#include <stdio.h>
#include <unistd.h>
...
# line 3792 "/Users/vicent/GitHub/Caliper/src/Caliper.tm.c"
...
#endif
{
	...
	if (_res) _res = _definepattern(mlp, (char *)"RQCD[scheme_, runAlpha_, runMass_, order_, gt_, Mz_, aMz_, mT_,                 h_, Q_]", (char *)"{scheme, runAlpha, runMass, order, gt, Mz, aMz, mT, h, Q}", 187);

...
# line 1493 "/Users/vicent/GitHubProjects/Caliper/src/Caliper.tm"
#include "mathlink.h"
#include "ftypes.h"
#include <stdio.h>
#include <unistd.h>
...
# line 2442 "/Users/vicent/GitHubProjects/Caliper/src/Caliper.tm.c"
...
void massivepiecebin P(( const char * _tp1, const char * _tp2, const char * _tp3, const char * _tp4, const char * _tp5, const char * _tp6, const char * _tp7, const char * _tp8, const char * _tp9, const char * _tp10, double _tp11, double _tp12, int _tp13, int _tp14, int _tp15, int _tp16, int _tp17, int _tp18, int _tp19, double _tp20, double _tp21, double _tp22, double _tp23, double _tp24, double _tp25, double _tp26, double _tp27, double _tp28, double _tp29, double _tp30, double _tp31, double _tp32, double _tp33, double _tp34, double _tp35, double _tp36, double _tp37, double _tp38, double _tp39, double _tp40, double _tp41, double _tp42, double _tp43, double _tp44, double _tp45, double _tp46, double _tp47, double _tp48, double _tp49, double _tp50, int _tp51, double _tp52, int _tp53, double _tp54, double _tp55, double _tp56, double _tp57, double _tp58, double _tp59, double _tp60, double * _tp61, long _tpl61, int _tp62));
...
#endif
{
	...
	if ( ! MLGetReal( mlp, &_tp60) ) goto L59;
	if ( ! MLGetRealList( mlp, &_tp61, &_tpl61) ) goto L60;
	if ( ! MLGetInteger( mlp, &_tp62) ) goto L61;
	if ( ! MLNewPacket(mlp) ) goto L62;

	massivepiecebin(_tp1, _tp2, _tp3, _tp4, _tp5, _tp6, _tp7, _tp8, _tp9, _tp10, _tp11, _tp12, _tp13, _tp14, _tp15, _tp16, _tp17, _tp18, _tp19, _tp20, _tp21, _tp22, _tp23, _tp24, _tp25, _tp26, _tp27, _tp28, _tp29, _tp30, _tp31, _tp32, _tp33, _tp34, _tp35, _tp36, _tp37, _tp38, _tp39, _tp40, _tp41, _tp42, _tp43, _tp44, _tp45, _tp46, _tp47, _tp48, _tp49, _tp50, _tp51, _tp52, _tp53, _tp54, _tp55, _tp56, _tp57, _tp58, _tp59, _tp60, _tp61, _tpl61, _tp62);

	res = 1;
L62: L61:	MLReleaseReal64List(mlp, _tp61, _tpl61);
L60: L59: L58: L57: L56: L55: L54: L53: L52: L51: L50: L49: L48: L47: L46: L45: L44: L43: L42: L41: L40: L39: L38: L37: L36: L35: L34: L33: L32: L31: L30: L29: L28: L27: L26: L25: L24: L23: L22: L21: L20: L19: L18: L17: L16: L15: L14: L13: L12: L11: L10:	MLReleaseString(mlp, _tp10);
L9:	MLReleaseString(mlp, _tp9);
L8:	MLReleaseString(mlp, _tp8);
L7:	MLReleaseString(mlp, _tp7);
...
double singularmasspiece P(( const char * _tp1, const char * _tp2, const char * _tp3, const char * _tp4, const char * _tp5, const char * _tp6, const char * _tp7, const char * _tp8, const char * _tp9, double _tp10, double _tp11, int _tp12, int _tp13, int _tp14, int _tp15, int _tp16, int _tp17, int _tp18, double _tp19, double _tp20, double _tp21, double _tp22, double _tp23, double _tp24, double _tp25, double _tp26, double _tp27, double _tp28, double _tp29, double _tp30, double _tp31, double _tp32, double _tp33, double _tp34, double _tp35, double _tp36, double _tp37, double _tp38, double _tp39, double _tp40, int * _tp41, long _tpl41, double _tp42, double _tp43, double _tp44, double _tp45, double _tp46, double _tp47, double _tp48, double _tp49));
...
#endif
{
	...
	if ( ! MLGetReal( mlp, &_tp39) ) goto L38;
	if ( ! MLGetReal( mlp, &_tp40) ) goto L39;
	if ( ! MLGetIntegerList( mlp, &_tp41, &_tpl41) ) goto L40;
	if ( ! MLGetReal( mlp, &_tp42) ) goto L41;
	if ( ! MLGetReal( mlp, &_tp43) ) goto L42;
	if ( ! MLGetReal( mlp, &_tp44) ) goto L43;
	if ( ! MLGetReal( mlp, &_tp45) ) goto L44;
	...
	if ( ! MLGetReal( mlp, &_tp48) ) goto L47;
	if ( ! MLGetReal( mlp, &_tp49) ) goto L48;
	if ( ! MLNewPacket(mlp) ) goto L49;

	_rp0 = singularmasspiece(_tp1, _tp2, _tp3, _tp4, _tp5, _tp6, _tp7, _tp8, _tp9, _tp10, _tp11, _tp12, _tp13, _tp14, _tp15, _tp16, _tp17, _tp18, _tp19, _tp20, _tp21, _tp22, _tp23, _tp24, _tp25, _tp26, _tp27, _tp28, _tp29, _tp30, _tp31, _tp32, _tp33, _tp34, _tp35, _tp36, _tp37, _tp38, _tp39, _tp40, _tp41, _tpl41, _tp42, _tp43, _tp44, _tp45, _tp46, _tp47, _tp48, _tp49);

	res = MLAbort ?
		MLPutFunction( mlp, "Abort", 0) : MLPutReal( mlp, _rp0);
L49: L48: L47: L46: L45: L44: L43: L42: L41:	MLReleaseInteger32List( mlp, _tp41, _tpl41);
L40: L39: L38: L37: L36: L35: L34: L33: L32: L31: L30: L29: L28: L27: L26: L25: L24: L23: L22: L21: L20: L19: L18: L17: L16: L15: L14: L13: L12: L11: L10: L9:	MLReleaseString(mlp, _tp9);
L8:	MLReleaseString(mlp, _tp8);
L7:	MLReleaseString(mlp, _tp7);
L6:	MLReleaseString(mlp, _tp6);
L5:	MLReleaseString(mlp, _tp5);
...
double singularmassdiffpiece P(( const char * _tp1, const char * _tp2, const char * _tp3, const char * _tp4, const char * _tp5, const char * _tp6, const char * _tp7, const char * _tp8, const char * _tp9, double _tp10, double _tp11, int _tp12, int _tp13, int _tp14, int _tp15, int _tp16, int _tp17, int _tp18, double _tp19, double _tp20, double _tp21, double _tp22, double _tp23, double _tp24, double _tp25, double _tp26, double _tp27, double _tp28, double _tp29, double _tp30, double _tp31, double _tp32, double _tp33, double _tp34, double _tp35, double _tp36, double _tp37, double _tp38, double _tp39, double _tp40, int * _tp41, long _tpl41, double _tp42, double _tp43, double _tp44, double _tp45, double _tp46, double _tp47, double _tp48, double _tp49, double _tp50));
...
#endif
{
	...
	_rp0 = singularmassdiffpiece(_tp1, _tp2, _tp3, _tp4, _tp5, _tp6, _tp7, _tp8, _tp9, _tp10, _tp11, _tp12, _tp13, _tp14, _tp15, _tp16, _tp17, _tp18, _tp19, _tp20, _tp21, _tp22, _tp23, _tp24, _tp25, _tp26, _tp27, _tp28, _tp29, _tp30, _tp31, _tp32, _tp33, _tp34, _tp35, _tp36, _tp37, _tp38, _tp39, _tp40, _tp41, _tpl41, _tp42, _tp43, _tp44, _tp45, _tp46, _tp47, _tp48, _tp49, _tp50);

	res = MLAbort ?
		MLPutFunction( mlp, "Abort", 0) : MLPutReal( mlp, _rp0);
L50: L49: L48: L47: L46: L45: L44: L43: L42: L41:	MLReleaseInteger32List( mlp, _tp41, _tpl41);
L40: L39: L38: L37: L36: L35: L34: L33: L32: L31: L30: L29: L28: L27: L26: L25: L24: L23: L22: L21: L20: L19: L18: L17: L16: L15: L14: L13: L12: L11: L10: L9:	MLReleaseString(mlp, _tp9);
L8:	MLReleaseString(mlp, _tp8);
L7:	MLReleaseString(mlp, _tp7);
L6:	MLReleaseString(mlp, _tp6);
...
static struct func {
	...
	const char  *f_name;
		...
		{ 5, 0, _tr0, "ewfactors" },
		{ 2, 0, _tr1, "gammar" },
		{46, 0, _tr2, "masslessprof" },
		{33, 0, _tr3, "findorigin" },
		{45, 0, _tr4, "masslessprofpiece" },
		{45, 0, _tr5, "masslessprofpiecelist" },
		{46, 0, _tr6, "masslesspiecebin" },
		{46, 0, _tr7, "masslessprofdiffpiece" },
		{46, 0, _tr8, "masslessproflist" },
		{47, 0, _tr9, "masslessbinlist" },
		{47, 0, _tr10, "masslessprofdiff" },
		{47, 0, _tr11, "masslessmoment" },
		{16, 0, _tr12, "profiles" },
		{22, 0, _tr13, "profilesmass" },
		{19, 0, _tr14, "massintersection" },
		{40, 0, _tr15, "nsmasspiece" },
		{41, 0, _tr16, "nsmassdiffpiece" },
		{41, 0, _tr17, "nsmass" },
		{42, 0, _tr18, "nsmassdiff" },
		{41, 0, _tr19, "hjmnsmass" },
		{42, 0, _tr20, "hjmnsmassdiff" },
		{36, 0, _tr21, "singular" },
		{35, 0, _tr22, "singularlist" },
		{37, 0, _tr23, "singulardiff" },
		{62, 0, _tr24, "massiveprof" },
		{43, 0, _tr25, "massorigin" },
		{61, 0, _tr26, "massiveprofpiece" },
		{61, 0, _tr27, "massiveprofpiecelist" },
		{62, 0, _tr28, "massivepiecebin" },
		{62, 0, _tr29, "massiveprofdiffpiece" },
		{63, 0, _tr30, "massiveprofdiff" },
		{62, 0, _tr31, "massiveproflist" },
		{63, 0, _tr32, "massivebinlist" },
		{63, 0, _tr33, "massivemoment" },
		{50, 0, _tr34, "singularmass" },
		{51, 0, _tr35, "singularmassdiff" },
		{41, 0, _tr36, "massnondist" },
		{42, 0, _tr37, "massnondistdiff" },
		{40, 0, _tr38, "massnondistpiece" },
		{41, 0, _tr39, "massnondistdiffpiece" },
		{49, 0, _tr40, "singularmasspiece" },
		{50, 0, _tr41, "singularmassdiffpiece" },
		{39, 0, _tr42, "singularhjm" },
		{36, 0, _tr43, "singularhjm1d" },
		{36, 0, _tr44, "singularhjm1dpiece" },
		{41, 0, _tr45, "singulardouble" },
		{37, 0, _tr46, "singularhjmpiece" },
		{39, 0, _tr47, "singulardoublepiece" },
		{35, 0, _tr48, "singularpiece" },
		{36, 0, _tr49, "singulardiffpiece" },
		{19, 0, _tr50, "diffdeltagap" },
		{21, 0, _tr51, "diffdeltagapmass" },
		{ 2, 0, _tr52, "hyperf32exact" },
		{ 4, 0, _tr53, "model" },
		{ 5, 0, _tr54, "modeldiff" },
		{ 5, 0, _tr55, "breitmodel" },
		{ 6, 0, _tr56, "breitmodeldiff" },
		{ 3, 0, _tr57, "taylor" },
		{ 3, 0, _tr58, "momentmodel" },
		{ 4, 0, _tr59, "modelpiece" },
		{ 3, 0, _tr60, "taylorpiece" },
		{ 4, 0, _tr61, "hyper2f1" },
		{ 3, 0, _tr62, "intecorre" },
		{ 3, 0, _tr63, "anomdim" },
		{ 2, 0, _tr64, "scoef" },
		...
		{ 3, 0, _tr67, "pfq" },
		{ 3, 0, _tr68, "elliptic3" },
		{ 2, 0, _tr69, "nglfunction" },
		{ 3, 0, _tr70, "nglsoft" },
		{ 3, 0, _tr71, "complexpolylog" },
		{ 2, 0, _tr72, "cli2" },
		{ 1, 0, _tr73, "thrustns1loop" },
		{ 8, 0, _tr74, "fomass" },
		{ 2, 0, _tr75, "thrustns2loop" },
		{ 2, 0, _tr76, "cli3" },
		{ 4, 0, _tr77, "delta" },
		{15, 0, _tr78, "deltagap" },
		{ 3, 0, _tr79, "coefmat" },
		...
		{ 5, 0, _tr81, "ktilde" },
		{13, 0, _tr82, "alphaqcd" },
		{13, 0, _tr83, "msbarmass" },
		{14, 0, _tr84, "polemass" },
		{13, 0, _tr85, "msbarmasslow" },
		{14, 0, _tr86, "msrmass" },
		{14, 0, _tr87, "mmfrommsr" },
		{15, 0, _tr88, "mmfrommsrnatural" },
		{15, 0, _tr89, "msrnaturalmass" },
		{16, 0, _tr90, "jetmass" },
		{16, 0, _tr91, "mmfromjetmass" },
		{13, 0, _tr92, "deltamsbar" },
		{15, 0, _tr93, "rhad" },
		{19, 0, _tr94, "rhadmass" },
		{14, 0, _tr95, "lambdaqcd" },
		{ 5, 0, _tr96, "kernels" },
		{ 2, 0, _tr97, "gammaderlist" },
		{ 2, 0, _tr98, "polygamma" },
		{ 7, 0, _tr99, "nglkernels" },
		{ 4, 0, _tr100, "nglintegral" },
		{ 5, 0, _tr101, "ngldoubleintegral" }
		};
...
static const char* evalstrs[] = {
	...
	", runAlpha, orderMass, runMass, order, run, nf, j3, s3, G3, mZ, ",
	"amZ, mT, muT, mB, muB, mC, muC, muLambda1, muLambda2, Q, beta, m",
	"u0, deltaLambda, Rat0, n0, delta0, n1, delta1, t2, ts, slope, cn",
	"t, eH, eS, eJ, mass, muM, ns, width, clen, lambda, R0, muR0, del",
	"0, h, gammaZ, sin2ThetaW, tauList], computes the cross section i",
	"ncluding profiles for massive cross section\"",
	(const char*)0,
	...
	"e, gap, space, cum, scheme, abs, current, xi, xiB, orderAlpha, r",
	"unAlpha, orderMass, runMass, order, run, nf, j3, s3, G3, mZ, amZ",
	", mT, muT, mB, muB, mC, muC, muLambda1, muLambda2, Q, muH, muJ, ",
	"muS, R, Rmass, muM, mu, width, c, lambda, R0, mu0, delta0, h, ga",
	"mmaZ, sin2ThetaW, tau] computes the Singular Massive Thrust and ",
	"C-parameter distrubution\"",
	(const char*)0,
...
#endif
{
	...
	if (_res) _res = _definepattern(mlp, (char *)"SingularPiece[hard_, shape_, gap_, space_, cum_, orderAlpha_, runAlpha_, order_,                 run_, nf_, j3_, s3_, G3_, mZ_, aMz_, mT_, muT_, mB_, muB_, mC_, muC_,                 muLambda_, Q_, muH_, muJ_, muS_, R_, mu_, c_, lambda_, R0_, mu0_, delta0_,                 h_, tau_, tau2_]", (char *)"{hard, shape, gap, space, cum, orderAlpha, runAlpha, order, run, nf, j3, s3, G3,                  mZ, aMz, mT, muT, mB, muB, mC, muC, muLambda, Q, muH, muJ, muS, R, mu, c,                  lambda, R0, mu0, delta0, h, tau, tau2}", 49);
	if (_res) _res = _definepattern(mlp, (char *)"DiffDeltaGap[str_, scheme_, order_, R0_, R1_, mu0_, mu1_, muLambda_,                 orderAlpha_, runAlpha_, nf_, Mz_, aMz_, mT_, muT_, mB_, muB_, mC_, muC_]", (char *)"{str, scheme, order, R0, R1, mu0, mu1, muLambda, orderAlpha, runAlpha,                  nf, Mz, aMz, mT, muT, mB, muB, mC, muC}", 50);
	if (_res) _res = _definepattern(mlp, (char *)"DiffDeltaGapMass[str_, order_, R0_, R1_, mu0_, mu1_, muM_, muLambda1_,                 muLambda2_, orderAlpha_, runAlpha_, runMass_, nf_, Mz_, aMz_, mT_, muT_,                 mB_, muB_, mC_, muC_]", (char *)"{str, order, R0, R1, mu0, mu1, muM, muLambda1, muLambda2, orderAlpha,                  runAlpha, runMass, nf, Mz, aMz, mT, muT, mB, muB, mC, muC}", 51);
	if (_res) _res = _definepattern(mlp, (char *)"HyperF32Exact[w_, x_]", (char *)"{w, x}", 52);
	if (_res) _res = _definepattern(mlp, (char *)"Model[c_, lambda_, k_, l_]", (char *)"{c, lambda, k, l}", 53);
	if (_res) _res = _definepattern(mlp, (char *)"Model[c_, lambda_, k_, l_, l2_]", (char *)"{c, lambda, k, l, l2}", 54);
	if (_res) _res = _definepattern(mlp, (char *)"BreitModel[c_, lambda_, width_, k_, l_]", (char *)"{c, lambda, width, k, l}", 55);
	if (_res) _res = _definepattern(mlp, (char *)"BreitModel[c_, lambda_, width_, k_, l_, l2_]", (char *)"{c, lambda, width, k, l, l2}", 56);
	if (_res) _res = _definepattern(mlp, (char *)"Taylor[c_, lambda_, k_]", (char *)"{c, lambda, k}", 57);
	if (_res) _res = _definepattern(mlp, (char *)"MomentModel[c_, lambda_, k_]", (char *)"{c, lambda, k}", 58);
	if (_res) _res = _definepattern(mlp, (char *)"ModelPiece[c_, lambda_, k_, l_]", (char *)"{c, lambda, k, l}", 59);
	if (_res) _res = _definepattern(mlp, (char *)"TaylorPiece[c_, lambda_, k_]", (char *)"{c, lambda, k}", 60);
	if (_res) _res = _definepattern(mlp, (char *)"Hyper2F1[a_, b_, c_, x_]", (char *)"{a, b, c, x}", 61);
	if (_res) _res = _definepattern(mlp, (char *)"InteCorre[b_, x0_, x1_]", (char *)"{b, x0, x1}", 62);
	if (_res) _res = _definepattern(mlp, (char *)"AnomDim[str_, nf_, G4_]", (char *)"{str, nf, G4}", 63);
	if (_res) _res = _definepattern(mlp, (char *)"Scoef[str_, nf_]", (char *)"{str, nf}", 64);
	if (_res) _res = _definepattern(mlp, (char *)"Polylog[n_, z_]", (char *)"{n, z}", 65);
	if (_res) _res = _definepattern(mlp, (char *)"DiLog[z_]", (char *)"{z}", 66);
	if (_res) _res = _definepattern(mlp, (char *)"pFq[a_, b_, z_]", (char *)"{a, b, z}", 67);
	if (_res) _res = _definepattern(mlp, (char *)"Elliptic3[psi_, k_, c_]", (char *)"{psi, k, c}", 68);
	if (_res) _res = _definepattern(mlp, (char *)"NGLFunction[n_, z_]", (char *)"{n, z}", 69);
	if (_res) _res = _definepattern(mlp, (char *)"NGLSoft[n_, z_]", (char *)"{n, Re[z], Im[z]}", 70);
	if (_res) _res = _definepattern(mlp, (char *)"ComplexPolylog[n_, z_]", (char *)"{n, Re[z], Im[z]}", 71);
	if (_res) _res = _definepattern(mlp, (char *)"CLi2[z_]", (char *)"{Re[z], Im[z]}", 72);
	if (_res) _res = _definepattern(mlp, (char *)"ThrustNS1loop[t_]", (char *)"{t}", 73);
	if (_res) _res = _definepattern(mlp, (char *)"FOMass[shape_, current_, m_, Q_, Mz_, gammaZ_, sin2ThetaW_, t_]", (char *)"{shape, current, m, Q, Mz, gammaZ, sin2ThetaW, t}", 74);
	if (_res) _res = _definepattern(mlp, (char *)"ThrustNS2loop[er_, t_]", (char *)"{er, t}", 75);
	if (_res) _res = _definepattern(mlp, (char *)"CLi3[z_]", (char *)"{Re[z], Im[z]}", 76);
	if (_res) _res = _definepattern(mlp, (char *)"Delta[str_, nf_, mu_, R_]", (char *)"{str, nf, mu, R}", 77);
	if (_res) _res = _definepattern(mlp, (char *)"DeltaGap[str_, orderAlpha_, runAlpha_, runMass_, nf_, mZ_, aMz_, mT_,                 muT_, mB_, muB_, mC_, muC_, mu_, R_]", (char *)"{str, orderAlpha, runAlpha, runMass, nf, mZ, aMz, mT, muT, mB, muB, mC,                  muC, mu, R}", 78);
	if (_res) _res = _definepattern(mlp, (char *)"CoefMat[str_, nf_, s3_]", (char *)"{str, nf, s3}", 79);
	if (_res) _res = _definepattern(mlp, (char *)"wTilde[order_, nf_, gamma_, a0_, a1_]", (char *)"{order, nf, gamma, a0, a1}", 80);
	if (_res) _res = _definepattern(mlp, (char *)"kTilde[order_, nf_, gamma_, a0_, a1_]", (char *)"{order, nf, gamma, a0, a1}", 81);
	if (_res) _res = _definepattern(mlp, (char *)"AlphaQCD[str_, order_, run_, nf_, Mz_, aMz_, mT_, muT_, mB_, muB_, mC_,                  muC_, mu_]", (char *)"{str, order, run, nf, Mz, aMz, mT, muT, mB, muB, mC, muC, mu}", 82);
	if (_res) _res = _definepattern(mlp, (char *)"MSbarMass[order_, runAlpha_, run_, nf_, Mz_, aMz_, mT_, muT_, mB_, muB_,                 mC_, muC_, mu_]", (char *)"{order, runAlpha, run, nf, Mz, aMz, mT, muT, mB, muB, mC, muC, mu}", 83);
	if (_res) _res = _definepattern(mlp, (char *)"PoleMass[orderAlpha_, runAlpha_, order_, run_, nf_, Mz_, aMz_, mT_, muT_,                 mB_, muB_, mC_, muC_, mu_]", (char *)"{orderAlpha, runAlpha, order, run, nf, Mz, aMz, mT, muT, mB, muB, mC, muC,                  mu}", 84);
	if (_res) _res = _definepattern(mlp, (char *)"MSbarMassLow[order_, runAlpha_, run_, nf_, Mz_, aMz_, mT_, muT_, mB_,                 muB_, mC_, muC_, mu_]", (char *)"{order, runAlpha, run, nf, Mz, aMz, mT, muT, mB, muB, mC, muC, mu}", 85);
	if (_res) _res = _definepattern(mlp, (char *)"MSRMass[order_, runAlpha_, run_, nf_, Mz_, aMz_, mT_, muT_, mB_, muB_,                 mC_, muC_, mu_, R_]", (char *)"{order, runAlpha, run, nf, Mz, aMz, mT, muT, mB, muB, mC, muC, mu, R}", 86);
	if (_res) _res = _definepattern(mlp, (char *)"mmfromMSR[order_, runAlpha_, run_, nf_, Mz_, aMz_, mT_, muT_, mB_, muB_,                 mC_, muC_, mu_, R_]", (char *)"{order, runAlpha, run, nf, Mz, aMz, mT, muT, mB, muB, mC, muC, mu, R}", 87);
	if (_res) _res = _definepattern(mlp, (char *)"mmfromMSRNatural[orderAlpha_, runAlpha_, order_, run_, nf_, Mz_, aMz_,                 mT_, muT_, mB_, muB_, mC_, muC_, mu_, R_]", (char *)"{orderAlpha, runAlpha, order, run, nf, Mz, aMz, mT, muT, mB, muB, mC, muC,                  mu, R}", 88);
	if (_res) _res = _definepattern(mlp, (char *)"MSRNaturalMass[orderAlpha_, runAlpha_, order_, run_, nf_, Mz_, aMz_,                 mT_, muT_, mB_, muB_, mC_, muC_, mu_, R_]", (char *)"{orderAlpha, runAlpha, order, run, nf, Mz, aMz, mT, muT, mB, muB, mC, muC,                  mu, R}", 89);
	if (_res) _res = _definepattern(mlp, (char *)"JetMass[orderAlpha_, runAlpha_, order_, run_, nf_, Mz_, aMz_, mT_,                 muT_, mB_, muB_, mC_, muC_, muLambda_, R_, mu_]", (char *)"{orderAlpha, runAlpha, order, run, nf, Mz, aMz, mT, muT, mB, muB, mC,                  muC, muLambda, R, mu}", 90);
	if (_res) _res = _definepattern(mlp, (char *)"mmFromJetMass[orderAlpha_, runAlpha_, order_, run_, nf_, Mz_, aMz_, mT_,                 muT_, mB_, muB_, mC_, muC_, muLambda_, R_, mu_]", (char *)"{orderAlpha, runAlpha, order, run, nf, Mz, aMz, mT, muT, mB, muB, mC,                  muC, muLambda, R, mu}", 91);
	if (_res) _res = _definepattern(mlp, (char *)"DeltaMSbar[order_, runAlpha_, run_, nf_, Mz_, aMz_, mT_, muT_, mB_, muB_,                  mC_, muC_, mu_]", (char *)"{order, runAlpha, run, nf, Mz, aMz, mT, muT, mB, muB, mC, muC, mu}", 92);
	if (_res) _res = _definepattern(mlp, (char *)"Rhad[scheme_, orderAlpha_, runAlpha_, order_, nf_, Mz_, aMz_, mT_, muT_,                  mB_, muB_, mC_, muC_, mu_, Q_]", (char *)"{scheme, orderAlpha, runAlpha, order, nf, Mz, aMz, mT, muT, mB, muB, mC,                  muC, mu, Q}", 93);
	if (_res) _res = _definepattern(mlp, (char *)"RhadMass[scheme_, current_, orderAlpha_, runAlpha_, runMass_, order_, nf_,                 Mz_, GammaZ_, sin2ThetaW_, aMz_, mT_, muT_, mB_, muB_, mC_, muC_, mu_, Q_]", (char *)"{scheme, current, orderAlpha, runAlpha, runMass, order, nf, Mz, GammaZ,                 sin2ThetaW, aMz, mT, muT, mB, muB, mC, muC, mu, Q}", 94);
	if (_res) _res = _definepattern(mlp, (char *)"LambdaQCD[scheme_, order_, runAlpha_, run_, nf_, Mz_, aMz_, mT_, muT_,                  mB_, muB_, mC_, muC_, mu_]", (char *)"{scheme, order, runAlpha, run, nf, Mz, aMz, mT, muT, mB, muB, mC, muC, mu}", 95);
	if (_res) _res = _definepattern(mlp, (char *)"Kernel[n_, width_, w_, mu_, p_]", (char *)"{n, width, w, mu, p}", 96);
	if (_res) _res = _definepattern(mlp, (char *)"GammaDerList[n_, w_]", (char *)"{n, w}", 97);
	if (_res) _res = _definepattern(mlp, (char *)"polyGamma[n_, w_]", (char *)"{n, w}", 98);
	if (_res) _res = _definepattern(mlp, (char *)"NGLKernel[n_, n1_, n2_, width_, w_, mu_, p_]", (char *)"{n, n1, n2, width, w, mu, p}", 99);
	if (_res) _res = _definepattern(mlp, (char *)"NGLIntegral[nf_, pow_, w1_, w2_]", (char *)"{nf, pow, w1, w2}", 100);
	if (_res) _res = _definepattern(mlp, (char *)"NGLDoubleIntegral[nf_, pow_, w1_, w2_, r_]", (char *)"{nf, pow, w1, w2, r}", 101);
...
#endif
{
	return _MLDoCallPacket( mlp, _tramps, 102);
} /* MLDoCallPacket */

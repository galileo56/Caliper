...
# line 2977 "/Users/vmateu/GitHub/Caliper/src/Caliper.tm"
#include "mathlink.h"
#include "ftypes.h"
#include <stdio.h>
#include <unistd.h>
...
double xinnllnonmix P(( double _tp1, double _tp2, double _tp3, double _tp4, double _tp5));
...
#endif
{
	...
	_rp0 = xinnllnonmix(_tp1, _tp2, _tp3, _tp4, _tp5);
...
double mnnllallc1inclsoftmixlog P(( double _tp1, double _tp2, double _tp3, double _tp4, double _tp5, double _tp6));
...
#endif
{
	...
	_rp0 = mnnllallc1inclsoftmixlog(_tp1, _tp2, _tp3, _tp4, _tp5, _tp6);
...
double mnllplusnnllnonmixc1 P(( double _tp1, double _tp2, double _tp3));
...
#endif
{
	...
	_rp0 = mnllplusnnllnonmixc1(_tp1, _tp2, _tp3);
...
double mnllc1 P(( double _tp1, double _tp2, double _tp3));
...
double vceffsnnll P(( double _tp1, double _tp2, double _tp3));
...
#endif
{
	...
	_rp0 = vceffsnnll(_tp1, _tp2, _tp3);
...
double a1pole P(( int _tp1, double _tp2, double _tp3, double _tp4, double _tp5, double _tp6, double _tp7));
...
#endif
{
	...
	_rp0 = a1pole(_tp1, _tp2, _tp3, _tp4, _tp5, _tp6, _tp7);
...
double xinnllmixusoft P(( double _tp1, double _tp2));
...
double mllc2 P(( double _tp1, double _tp2));
...
double vssll P(( double _tp1, double _tp2));
...
double vrsll P(( double _tp1, double _tp2));
...
double v2sll P(( double _tp1, double _tp2, double _tp3));
...
double xinll P(( double _tp1, double _tp2, double _tp3));
...
double vk1sll P(( double _tp1, double _tp2));
...
double vk2sll P(( double _tp1, double _tp2));
...
double vkeffsll P(( double _tp1, double _tp2));
...
void afroms P(( const char * _tp1, int _tp2, double _tp3));
...
void ql P(( const char * _tp1, int _tp2, int _tp3, double _tp4));
...
void anasy P(( const char * _tp1, int _tp2, int _tp3, double _tp4));
...
void anlambda P(( const char * _tp1, int _tp2, double _tp3));
...
double n12ratio P(( const char * _tp1, int _tp2, int _tp3, double _tp4, double _tp5));
...
#endif
{
	...
	_rp0 = n12ratio(_tp1, _tp2, _tp3, _tp4, _tp5);
...
double n12residue P(( const char * _tp1, int _tp2, int _tp3, double _tp4, double _tp5));
...
#endif
{
	...
	_rp0 = n12residue(_tp1, _tp2, _tp3, _tp4, _tp5);
...
double n12rs P(( const char * _tp1, int _tp2, int _tp3, int _tp4, double _tp5, double _tp6));
...
#endif
{
	...
	_rp0 = n12rs(_tp1, _tp2, _tp3, _tp4, _tp5, _tp6);
...
double rsmass P(( const char * _tp1, const char * _tp2, int _tp3, int _tp4, int _tp5, int _tp6, int _tp7, double _tp8, double _tp9, double _tp10, double _tp11, double _tp12, double _tp13, double _tp14, double _tp15, double _tp16, double _tp17));
...
#endif
{
	...
	_rp0 = rsmass(_tp1, _tp2, _tp3, _tp4, _tp5, _tp6, _tp7, _tp8, _tp9, _tp10, _tp11, _tp12, _tp13, _tp14, _tp15, _tp16, _tp17);

	res = MLAbort ?
		MLPutFunction( mlp, "Abort", 0) : MLPutReal( mlp, _rp0);
L17: L16: L15: L14: L13: L12: L11: L10: L9: L8: L7: L6: L5: L4: L3: L2:	MLReleaseString(mlp, _tp2);
L1:	MLReleaseString(mlp, _tp1);
...
double findenergy P(( int _tp1, int _tp2, int _tp3, int _tp4, int _tp5, const char * _tp6, const char * _tp7, const char * _tp8, const char * _tp9, const char * _tp10, const char * _tp11, int _tp12, int _tp13, int _tp14, int _tp15, int _tp16, double _tp17, double _tp18, double _tp19, double _tp20, double _tp21, double _tp22, double _tp23, double _tp24, double _tp25, double _tp26, double _tp27, double _tp28, double _tp29));
...
#endif
{
	...
	_rp0 = findenergy(_tp1, _tp2, _tp3, _tp4, _tp5, _tp6, _tp7, _tp8, _tp9, _tp10, _tp11, _tp12, _tp13, _tp14, _tp15, _tp16, _tp17, _tp18, _tp19, _tp20, _tp21, _tp22, _tp23, _tp24, _tp25, _tp26, _tp27, _tp28, _tp29);

	res = MLAbort ?
		MLPutFunction( mlp, "Abort", 0) : MLPutReal( mlp, _rp0);
L29: L28: L27: L26: L25: L24: L23: L22: L21: L20: L19: L18: L17: L16: L15: L14: L13: L12: L11:	MLReleaseString(mlp, _tp11);
L10:	MLReleaseString(mlp, _tp10);
L9:	MLReleaseString(mlp, _tp9);
L8:	MLReleaseString(mlp, _tp8);
L7:	MLReleaseString(mlp, _tp7);
...
double optimalrvfns P(( const char * _tp1, const char * _tp2, double _tp3, const char * _tp4, int _tp5, int _tp6, int _tp7, int _tp8, int _tp9, double _tp10, double _tp11, double _tp12, double _tp13, double _tp14, double _tp15, double _tp16, double _tp17, double _tp18, double _tp19, double _tp20));
...
#endif
{
	...
	_rp0 = optimalrvfns(_tp1, _tp2, _tp3, _tp4, _tp5, _tp6, _tp7, _tp8, _tp9, _tp10, _tp11, _tp12, _tp13, _tp14, _tp15, _tp16, _tp17, _tp18, _tp19, _tp20);

	res = MLAbort ?
		MLPutFunction( mlp, "Abort", 0) : MLPutReal( mlp, _rp0);
L20: L19: L18: L17: L16: L15: L14: L13: L12: L11: L10: L9: L8: L7: L6: L5: L4:	MLReleaseString(mlp, _tp4);
L3: L2:	MLReleaseString(mlp, _tp2);
L1:	MLReleaseString(mlp, _tp1);
...
double optimalr2 P(( double _tp1, int _tp2, int _tp3, int _tp4, int _tp5, double _tp6, double _tp7, double _tp8, double _tp9, double _tp10, double _tp11, double _tp12, double _tp13, double _tp14));
...
#endif
{
	...
	_rp0 = optimalr2(_tp1, _tp2, _tp3, _tp4, _tp5, _tp6, _tp7, _tp8, _tp9, _tp10, _tp11, _tp12, _tp13, _tp14);
...
void deltamsbar P(( int _tp1, int _tp2, int _tp3, double _tp4, double _tp5, double _tp6, double _tp7, double _tp8, double _tp9, double _tp10, double _tp11, double _tp12));
...
#endif
{
	...
	deltamsbar(_tp1, _tp2, _tp3, _tp4, _tp5, _tp6, _tp7, _tp8, _tp9, _tp10, _tp11, _tp12);
...
#if MLPROTOTYPES
static int _tr214( MLINK mlp)
#else
static int _tr214(mlp) MLINK mlp;
#endif
{
	int	res = 0;
	const char * _tp1;
...
#if MLPROTOTYPES
static int _tr215( MLINK mlp)
#else
static int _tr215(mlp) MLINK mlp;
#endif
{
	int	res = 0;
	const char * _tp1;
...
#if MLPROTOTYPES
static int _tr216( MLINK mlp)
#else
static int _tr216(mlp) MLINK mlp;
#endif
{
	int	res = 0;
	const char * _tp1;
...
#if MLPROTOTYPES
static int _tr217( MLINK mlp)
#else
static int _tr217(mlp) MLINK mlp;
#endif
{
	int	res = 0;
	const char * _tp1;
...
#if MLPROTOTYPES
static int _tr218( MLINK mlp)
#else
static int _tr218(mlp) MLINK mlp;
#endif
{
	int	res = 0;
	const char * _tp1;
...
#if MLPROTOTYPES
static int _tr219( MLINK mlp)
#else
static int _tr219(mlp) MLINK mlp;
#endif
{
	int	res = 0;
	const char * _tp1;
...
#if MLPROTOTYPES
static int _tr220( MLINK mlp)
#else
static int _tr220(mlp) MLINK mlp;
#endif
{
	int	res = 0;
	const char * _tp1;
...
#if MLPROTOTYPES
static int _tr221( MLINK mlp)
#else
static int _tr221(mlp) MLINK mlp;
#endif
{
	int	res = 0;
	const char * _tp1;
...
#if MLPROTOTYPES
static int _tr222( MLINK mlp)
#else
static int _tr222(mlp) MLINK mlp;
#endif
{
	int	res = 0;
	const char * _tp1;
...
#if MLPROTOTYPES
static int _tr223( MLINK mlp)
#else
static int _tr223(mlp) MLINK mlp;
#endif
{
	int	res = 0;
	int _tp1;
...
#if MLPROTOTYPES
static int _tr224( MLINK mlp)
#else
static int _tr224(mlp) MLINK mlp;
#endif
{
	int	res = 0;
	int _tp1;
...
#if MLPROTOTYPES
static int _tr225( MLINK mlp)
#else
static int _tr225(mlp) MLINK mlp;
#endif
{
	int	res = 0;
	int _tp1;
...
#if MLPROTOTYPES
static int _tr226( MLINK mlp)
#else
static int _tr226(mlp) MLINK mlp;
#endif
{
	int	res = 0;
	int _tp1;
...
#if MLPROTOTYPES
static int _tr227( MLINK mlp)
#else
static int _tr227(mlp) MLINK mlp;
#endif
{
	int	res = 0;
	int _tp1;
...
#if MLPROTOTYPES
static int _tr228( MLINK mlp)
#else
static int _tr228(mlp) MLINK mlp;
#endif
{
	int	res = 0;
	int _tp1;
...
static struct func {
	...
	const char  *f_name;
		...
		{ 2, 0, _tr1, "cdigamma" },
		{ 2, 0, _tr2, "ctrigamma" },
		{ 5, 0, _tr3, "xinnllnonmix" },
		{ 3, 0, _tr4, "xinnllsoftmixlogc1" },
		{ 6, 0, _tr5, "mnnllallc1inclsoftmixlog" },
		{ 3, 0, _tr6, "mnllplusnnllnonmixc1" },
		{ 3, 0, _tr7, "mnllc1" },
		{ 3, 0, _tr8, "vceffsnnll" },
		{19, 0, _tr9, "rnrqcd" },
		{14, 0, _tr10, "qswitch" },
		...
		{ 4, 0, _tr104, "anasy" },
		{ 3, 0, _tr105, "anlambda" },
		{ 2, 0, _tr106, "msbardeltapiece" },
		{ 3, 0, _tr107, "alphamatchinglog" },
		{ 2, 0, _tr108, "alphamatchinginverse" },
		{ 3, 0, _tr109, "ccoef" },
		{ 2, 0, _tr110, "pscoef" },
		{ 5, 0, _tr111, "n12" },
		{ 5, 0, _tr112, "n12ratio" },
		{ 5, 0, _tr113, "n12residue" },
		{ 6, 0, _tr114, "n12rs" },
		{ 4, 0, _tr115, "n12generic" },
		{ 2, 0, _tr116, "scoef" },
		{ 2, 0, _tr117, "scoefgamma" },
		{ 3, 0, _tr118, "scoeflambda" },
		{ 2, 0, _tr119, "polylog" },
		{ 1, 0, _tr120, "dilog" },
		{ 3, 0, _tr121, "pfq" },
		{ 3, 0, _tr122, "elliptic3" },
		{ 2, 0, _tr123, "nglfunction" },
		{ 3, 0, _tr124, "nglsoft" },
		{ 3, 0, _tr125, "complexpolylog" },
		{ 2, 0, _tr126, "cli2" },
		{ 5, 0, _tr127, "upsilondeltacharm" },
		{13, 0, _tr128, "deltacharmexact" },
		{ 5, 0, _tr129, "upsilondeltacharmbin" },
		{ 3, 0, _tr130, "deltacharm3" },
		{ 3, 0, _tr131, "deltacharm3der" },
		{ 3, 0, _tr132, "gammarcharm3" },
		{ 1, 0, _tr133, "deltacharm2" },
		{ 1, 0, _tr134, "p2" },
		{ 2, 0, _tr135, "pi0" },
		{ 3, 0, _tr136, "pi0der" },
		{ 3, 0, _tr137, "pi1der" },
		...
		{ 2, 0, _tr141, "pi2der" },
		{ 1, 0, _tr142, "p2int" },
		{ 2, 0, _tr143, "deltabottomcharm" },
		{ 2, 0, _tr144, "gammarbottomcharm" },
		{ 2, 0, _tr145, "p2double" },
		{ 1, 0, _tr146, "deltacharmnh" },
		{ 1, 0, _tr147, "deltacharmglue" },
		{ 1, 0, _tr148, "deltacharmglueder" },
		{ 1, 0, _tr149, "deltacharmnl" },
		{ 1, 0, _tr150, "deltacharmnhder" },
		{ 1, 0, _tr151, "deltacharmnlder" },
		{ 1, 0, _tr152, "gammarcharm2" },
		{ 1, 0, _tr153, "deltacharm2der" },
		{ 1, 0, _tr154, "thrustns1loop" },
		{ 8, 0, _tr155, "fomass" },
		{ 2, 0, _tr156, "thrustns2loop" },
		{ 2, 0, _tr157, "cli3" },
		{ 4, 0, _tr158, "delta" },
		{15, 0, _tr159, "deltagap" },
		{14, 0, _tr160, "psdelta" },
		{ 3, 0, _tr161, "coefmat" },
		{ 5, 0, _tr162, "wtilde" },
		{ 5, 0, _tr163, "ktilde" },
		{14, 0, _tr164, "alphaqcd" },
		{10, 0, _tr165, "alphaqed" },
		{15, 0, _tr166, "alphacomplex" },
		{13, 0, _tr167, "msbarmass" },
		{14, 0, _tr168, "polemass" },
		{13, 0, _tr169, "msbarmasslow" },
		{18, 0, _tr170, "msrmass" },
		{17, 0, _tr171, "rsmass" },
		{20, 0, _tr172, "msrvfns" },
		{21, 0, _tr173, "msrtop" },
		{27, 0, _tr174, "nrqcd" },
		{28, 0, _tr175, "nrqcddercharm" },
		{28, 0, _tr176, "nrqcdderalpha" },
		{28, 0, _tr177, "massiter" },
		{28, 0, _tr178, "massexpand" },
		{30, 0, _tr179, "findmass" },
		{29, 0, _tr180, "findenergy" },
		{35, 0, _tr181, "masserror" },
		{34, 0, _tr182, "masslist" },
		{33, 0, _tr183, "nrqcdlist" },
		{33, 0, _tr184, "upsilonlist" },
		{31, 0, _tr185, "corrmat" },
		{28, 0, _tr186, "chi2nrqcd" },
		{28, 0, _tr187, "chi2minnrqcd" },
		{28, 0, _tr188, "chi2minalphanrqcd" },
		{28, 0, _tr189, "chi2minalphambnrqcd" },
		{31, 0, _tr190, "errmat" },
		{31, 0, _tr191, "errmatrices" },
		{34, 0, _tr192, "nrqcderror" },
		{18, 0, _tr193, "optimalr" },
		{20, 0, _tr194, "optimalrvfns" },
		{14, 0, _tr195, "optimalr2" },
		{16, 0, _tr196, "mmfrommsr" },
		{16, 0, _tr197, "jetmass" },
		{16, 0, _tr198, "mmfromjetmass" },
		{12, 0, _tr199, "deltamsbar" },
		{15, 0, _tr200, "rhad" },
		{19, 0, _tr201, "sigmahad" },
		{21, 0, _tr202, "sigmarad" },
		{22, 0, _tr203, "sigmaradcum" },
		{22, 0, _tr204, "sigmaradcone" },
		{23, 0, _tr205, "sigmaradconecum" },
		{ 1, 0, _tr206, "rhadcoefs" },
		{19, 0, _tr207, "rhadmass" },
		{20, 0, _tr208, "sigmamass" },
		{22, 0, _tr209, "sigmamassrad" },
		{23, 0, _tr210, "sigmamassradcum" },
		{23, 0, _tr211, "sigmamassradcone" },
		{24, 0, _tr212, "sigmamassradconecum" },
		{15, 0, _tr213, "rqcd" },
		{16, 0, _tr214, "rexp" },
		{18, 0, _tr215, "rmatched" },
		{21, 0, _tr216, "sigmamatched" },
		{23, 0, _tr217, "sigmamatchedrad" },
		{24, 0, _tr218, "sigmamatchedradcum" },
		{24, 0, _tr219, "sigmamatchedradcone" },
		{25, 0, _tr220, "sigmamatchedradconecum" },
		{20, 0, _tr221, "rmatchedlist" },
		{14, 0, _tr222, "lambdaqcd" },
		{ 5, 0, _tr223, "kernels" },
		{ 2, 0, _tr224, "gammaderlist" },
		{ 2, 0, _tr225, "polygamma" },
		{ 7, 0, _tr226, "nglkernels" },
		{ 4, 0, _tr227, "nglintegral" },
		{ 5, 0, _tr228, "ngldoubleintegral" }
		};
...
static const char* evalstrs[] = {
	...
	", mtpole, gt, h, nu]\"",
	(const char*)0,
	"A1Pole::usage = \"A1Pole[order, En, mtpole, gamtop, asoft, VcsNNL",
	"L, musoft]\"",
	(const char*)0,
	...
	(const char*)0,
	"VssLL::usage = \"VssLL[ah, as]\"",
	(const char*)0,
	"Vk1sLL::usage = \"Vk1sLL[as, au]\"",
	(const char*)0,
	"Vk2sLL::usage = \"Vk2sLL[ah, as]\"",
	(const char*)0,
	"VkeffsLL::usage = \"VkeffsLL[ah, as]\"",
	(const char*)0,
	"VcsLL::usage = \"VcsLL[as]\"",
	(const char*)0,
	"VrsLL::usage = \"VrsLL[as, au]\"",
	(const char*)0,
	"V2sLL::usage = \"V2sLL[ah, as, au]\"",
	(const char*)0,
	"XiNLL::usage = \"XiNLL[ah, as, au]\"",
	(const char*)0,
	"VceffsNNLL::usage = \"VceffsNNLL[asNNLL, as, au]\"",
	(const char*)0,
	"XiNNLLmixUsoft::usage = \"XiNNLLmixUsoft[ah, as]\"",
	(const char*)0,
	"MLLc2::usage = \"MLLc2[nl, ah, au]\"",
	(const char*)0,
	"MNLLc1::usage = \"MNLLc1[ah, as, au]\"",
	(const char*)0,
	"MNLLplusNNLLnonmixc1::usage = \"MNLLplusNNLLnonmixc1[ah, as, au]\"",
	(const char*)0,
	"MNNLLAllc1InclSoftMixLog::usage = \"MNNLLAllc1InclSoftMixLog[ah, ",
	"as, au, nu, hh, ss]\"",
	(const char*)0,
	"XiNNLLSoftMixLogc1::usage = \"XiNNLLSoftMixLogc1[ah, nu, hh]\"",
	(const char*)0,
	"XiNNLLnonmix::usage = \"XiNNLLnonmix[ah, as, au, hh, ss]\"",
	(const char*)0,
	...
	(const char*)0,
	"Ql::usage = \"Ql[str, nf, order, lambda] computes the Ql coeffici",
	"ents\"",
	(const char*)0,
	"aNasy::usage = \"aNasy[str, nf, order, lambda] computes the asymp",
	"totic aN coefficients\"",
	(const char*)0,
	"aFromS::usage = \"aFromS[str, nf, lambda] computes the a coeffici",
	"ents from the sCoefs\"",
	(const char*)0,
	"anLambda::usage = \"anLambda[str, nf, lambda] computes the lambda",
	...
	"rmalon sum rule\"",
	(const char*)0,
	"N12Ratio::usage = \"N12Ratio[str, order, nf, lambda, err] compute",
	"s the renormalon residue by the ratio method\"",
	(const char*)0,
	"N12Residue::usage = \"N12Residue[str, order, nf, lambda, err] com",
	"putes the renormalon residue by the residue method\"",
	(const char*)0,
	"N12RS::usage = \"N12RS[str, order, n, nf, lambda, err] computes t",
	"he renormalon residue by the MSR-RS mass consistency\"",
	(const char*)0,
	...
	(const char*)0,
	"RSMass::usage = \"RSMass[type, method, orderAlpha, runAlpha, orde",
	"r, run, nf, Mz, aMz, mT, muT, mB, muB, mC, muC, lambda, R] compu",
	"tes the RS-scheme running of the quark masses.\"",
	(const char*)0,
	...
	".\"",
	(const char*)0,
	"FindEnergy::usage = \"FindEnergy[ord, n, l, j, s, iter, charm, sc",
	"heme, average, method, counting, orderAlpha, runAlpha, order, ru",
	"n, nl, mZ, amZ, mT, muT, mB, muB, mC, muC, lambda1, lambda2, lam",
	", mu, R] finds the quarkonium energy levels.\"",
	(const char*)0,
	...
	(const char*)0,
	"OptimalR2::usage = \"OptimalR2[n, orderAlpha, runAlpha, run, nf, ",
	"Mz, aMz, mT, muT, mB, muB, mC, muC, mass] computes the Optimal R",
	" scale for quarkonium.\"",
	(const char*)0,
	...
	(const char*)0,
	"DeltaMSbar::usage = \"DeltaMSbar[order, runAlpha, nf, Mz, aMz, mT",
	", muT, mB, muB, mC, muC, mu] computes the running of the quark m",
	"asses with flavor matching.\"",
	(const char*)0,
...
#endif
{
	...
	if (_res) _res = _doevalstr( mlp, 215);
	if (_res) _res = _doevalstr( mlp, 216);
	if (_res) _res = _doevalstr( mlp, 217);
	if (_res) _res = _doevalstr( mlp, 218);
	if (_res) _res = _doevalstr( mlp, 219);
	if (_res) _res = _doevalstr( mlp, 220);
	if (_res) _res = _doevalstr( mlp, 221);
	if (_res) _res = _doevalstr( mlp, 222);
	if (_res) _res = _doevalstr( mlp, 223);
	...
	if (_res) _res = _definepattern(mlp, (char *)"XiNNLLnonmix[ah_, as_, au_, hh_, ss_]", (char *)"{ah, as, au, hh, ss}", 3);
	if (_res) _res = _definepattern(mlp, (char *)"XiNNLLSoftMixLogc1[ah_, nu_, hh_]", (char *)"{ah, nu, hh}", 4);
	if (_res) _res = _definepattern(mlp, (char *)"MNNLLAllc1InclSoftMixLog[ah_, as_, au_, nu_, hh_, ss_]", (char *)"{ah, as, au, nu, hh, ss}", 5);
	if (_res) _res = _definepattern(mlp, (char *)"MNLLplusNNLLnonmixc1[ah_, as_, au_]", (char *)"{ah, as, au}", 6);
	if (_res) _res = _definepattern(mlp, (char *)"MNLLc1[ah_, as_, au_]", (char *)"{ah, as, au}", 7);
	if (_res) _res = _definepattern(mlp, (char *)"VceffsNNLL[asNNLL_, ah_, as_]", (char *)"{asNNLL, ah, as}", 8);
	...
	if (_res) _res = _definepattern(mlp, (char *)"A1Pole[order_, En_, mtpole_, gamtop_, asoft_, VcsNNLL_, musoft_]", (char *)"{order, En, mtpole, gamtop, asoft, VcsNNLL, musoft}", 12);
	if (_res) _res = _definepattern(mlp, (char *)"XiNNLLmixUsoft[ah_, au_]", (char *)"{ah, au}", 13);
	if (_res) _res = _definepattern(mlp, (char *)"MLLc2[ah_, as_]", (char *)"{ah, as}", 14);
	if (_res) _res = _definepattern(mlp, (char *)"VssLL[ah_, as_]", (char *)"{ah, as}", 15);
	if (_res) _res = _definepattern(mlp, (char *)"VcsLL[as_]", (char *)"{as}", 16);
	if (_res) _res = _definepattern(mlp, (char *)"VrsLL[as_, au_]", (char *)"{as, au}", 17);
	if (_res) _res = _definepattern(mlp, (char *)"V2sLL[ah_, au_, as_]", (char *)"{ah, au, as}", 18);
	if (_res) _res = _definepattern(mlp, (char *)"XiNLL[ah_, au_, as_]", (char *)"{ah, au, as}", 19);
	if (_res) _res = _definepattern(mlp, (char *)"Vk1sLL[ah_, as_]", (char *)"{ah, as}", 20);
	if (_res) _res = _definepattern(mlp, (char *)"Vk2sLL[ah_, as_]", (char *)"{ah, as}", 21);
	if (_res) _res = _definepattern(mlp, (char *)"VkeffsLL[ah_, as_]", (char *)"{ah, as}", 22);
	...
	if (_res) _res = _definepattern(mlp, (char *)"aFromS[str_, nf_, G4_]", (char *)"{str, nf, G4}", 102);
	if (_res) _res = _definepattern(mlp, (char *)"Ql[str_, nf_, order_, G4_]", (char *)"{str, nf, order, G4}", 103);
	if (_res) _res = _definepattern(mlp, (char *)"aNasy[str_, nf_, order_, G4_]", (char *)"{str, nf, order, G4}", 104);
	if (_res) _res = _definepattern(mlp, (char *)"anLambda[str_, nf_, G4_]", (char *)"{str, nf, G4}", 105);
	if (_res) _res = _definepattern(mlp, (char *)"MSbarDeltaPiece[nl_, nh_]", (char *)"{nl, nh}", 106);
	if (_res) _res = _definepattern(mlp, (char *)"AlphaMatchingLog[str_, direction_, nf_]", (char *)"{str, direction, nf}", 107);
	if (_res) _res = _definepattern(mlp, (char *)"AlphaMatchingInverse[str_, nf_]", (char *)"{str, nf}", 108);
	if (_res) _res = _definepattern(mlp, (char *)"cCoef[nf_, order_, n_]", (char *)"{nf, order, n}", 109);
	if (_res) _res = _definepattern(mlp, (char *)"PSCoef[nf_, lg_]", (char *)"{nf, lg}", 110);
	if (_res) _res = _definepattern(mlp, (char *)"N12[str_, order_, nf_, Lambda_, err_]", (char *)"{str, order, nf, Lambda, err}", 111);
	if (_res) _res = _definepattern(mlp, (char *)"N12Ratio[str_, order_, nf_, Lambda_, err_]", (char *)"{str, order, nf, Lambda, err}", 112);
	if (_res) _res = _definepattern(mlp, (char *)"N12Residue[str_, order_, nf_, Lambda_, err_]", (char *)"{str, order, nf, Lambda, err}", 113);
	if (_res) _res = _definepattern(mlp, (char *)"N12RS[str_, order_, n_, nf_, Lambda_, err_]", (char *)"{str, order, n, nf, Lambda, err}", 114);
	if (_res) _res = _definepattern(mlp, (char *)"N12Generic[aCoef_, order_, nf_, Lambda_]", (char *)"{aCoef, order, nf, Lambda}", 115);
	if (_res) _res = _definepattern(mlp, (char *)"sCoef[str_, nf_]", (char *)"{str, nf}", 116);
	if (_res) _res = _definepattern(mlp, (char *)"sCoefGamma[gama_, nf_]", (char *)"{gama, nf}", 117);
	if (_res) _res = _definepattern(mlp, (char *)"sCoefLambda[str_, nf_, lambda_]", (char *)"{str, nf, lambda}", 118);
	if (_res) _res = _definepattern(mlp, (char *)"Polylog[n_, z_]", (char *)"{n, z}", 119);
	if (_res) _res = _definepattern(mlp, (char *)"DiLog[z_]", (char *)"{z}", 120);
	if (_res) _res = _definepattern(mlp, (char *)"pFq[a_, b_, z_]", (char *)"{a, b, z}", 121);
	if (_res) _res = _definepattern(mlp, (char *)"Elliptic3[psi_, k_, c_]", (char *)"{psi, k, c}", 122);
	if (_res) _res = _definepattern(mlp, (char *)"NGLFunction[n_, z_]", (char *)"{n, z}", 123);
	if (_res) _res = _definepattern(mlp, (char *)"NGLSoft[n_, z_]", (char *)"{n, Re[z], Im[z]}", 124);
	if (_res) _res = _definepattern(mlp, (char *)"ComplexPolylog[n_, z_]", (char *)"{n, Re[z], Im[z]}", 125);
	if (_res) _res = _definepattern(mlp, (char *)"CLi2[z_]", (char *)"{Re[z], Im[z]}", 126);
	if (_res) _res = _definepattern(mlp, (char *)"UpsilonDeltaCharm[n_, l_, alpha_, mb_, mc_]", (char *)"{n, l, alpha, mb, mc}", 127);
	if (_res) _res = _definepattern(mlp, (char *)"DeltaCharmExact[charm_, type_, scheme_, average_, n_, l_, j_,                 s_, nl_, mH_, mL_, mu_, alp_]", (char *)"{charm, type, scheme, average, n, l, j, s, nl, mH, mL, mu, alp}", 128);
	if (_res) _res = _definepattern(mlp, (char *)"UpsilonDeltaCharmBin[n_, l_, alpha_, mb_, mc_]", (char *)"{n, l, alpha, mb, mc}", 129);
	if (_res) _res = _definepattern(mlp, (char *)"DeltaCharm3[nl_, nh_, z_]", (char *)"{nl, nh, z}", 130);
	if (_res) _res = _definepattern(mlp, (char *)"DeltaCharm3Der[nl_, nh_, z_]", (char *)"{nl, nh, z}", 131);
	if (_res) _res = _definepattern(mlp, (char *)"GammaRCharm3[nl_, nh_, z_]", (char *)"{nl, nh, z}", 132);
	if (_res) _res = _definepattern(mlp, (char *)"DeltaCharm2[z_]", (char *)"{z}", 133);
	if (_res) _res = _definepattern(mlp, (char *)"P2[z_]", (char *)"{z}", 134);
	if (_res) _res = _definepattern(mlp, (char *)"Pi0[z_]", (char *)"{Re[z], Im[z]}", 135);
	if (_res) _res = _definepattern(mlp, (char *)"Pi0Der[i_, z_]", (char *)"{i, Re[z], Im[z]}", 136);
	if (_res) _res = _definepattern(mlp, (char *)"Pi1Der[i_, z_]", (char *)"{i, Re[z], Im[z]}", 137);
	if (_res) _res = _definepattern(mlp, (char *)"Pi1[z_]", (char *)"{Re[z], Im[z]}", 138);
	if (_res) _res = _definepattern(mlp, (char *)"Pi3[z_]", (char *)"{Re[z], Im[z]}", 139);
	if (_res) _res = _definepattern(mlp, (char *)"Pi2[z_]", (char *)"{Re[z], Im[z]}", 140);
	if (_res) _res = _definepattern(mlp, (char *)"Pi2Der[z_]", (char *)"{Re[z], Im[z]}", 141);
	if (_res) _res = _definepattern(mlp, (char *)"P2Int[z_]", (char *)"{z}", 142);
	if (_res) _res = _definepattern(mlp, (char *)"DeltaBottomCharm[z1_, z2_]", (char *)"{z1, z2}", 143);
	if (_res) _res = _definepattern(mlp, (char *)"GammaRBottomCharm[z1_, z2_]", (char *)"{z1, z2}", 144);
	if (_res) _res = _definepattern(mlp, (char *)"P2Double[z1_, z2_]", (char *)"{z1, z2}", 145);
	if (_res) _res = _definepattern(mlp, (char *)"DeltaCharmNh[z_]", (char *)"{z}", 146);
	if (_res) _res = _definepattern(mlp, (char *)"DeltaCharmGlue[z_]", (char *)"{z}", 147);
	if (_res) _res = _definepattern(mlp, (char *)"DeltaCharmGlueDer[z_]", (char *)"{z}", 148);
	if (_res) _res = _definepattern(mlp, (char *)"DeltaCharmNl[z_]", (char *)"{z}", 149);
	if (_res) _res = _definepattern(mlp, (char *)"DeltaCharmNhDer[z_]", (char *)"{z}", 150);
	if (_res) _res = _definepattern(mlp, (char *)"DeltaCharmNlDer[z_]", (char *)"{z}", 151);
	if (_res) _res = _definepattern(mlp, (char *)"GammaRCharm2[z_]", (char *)"{z}", 152);
	if (_res) _res = _definepattern(mlp, (char *)"DeltaCharm2Der[z_]", (char *)"{z}", 153);
	if (_res) _res = _definepattern(mlp, (char *)"ThrustNS1loop[t_]", (char *)"{t}", 154);
	if (_res) _res = _definepattern(mlp, (char *)"FOMass[shape_, current_, m_, Q_, Mz_, gammaZ_, sin2ThetaW_, t_]", (char *)"{shape, current, m, Q, Mz, gammaZ, sin2ThetaW, t}", 155);
	if (_res) _res = _definepattern(mlp, (char *)"ThrustNS2loop[er_, t_]", (char *)"{er, t}", 156);
	if (_res) _res = _definepattern(mlp, (char *)"CLi3[z_]", (char *)"{Re[z], Im[z]}", 157);
	if (_res) _res = _definepattern(mlp, (char *)"Delta[str_, nf_, mu_, R_]", (char *)"{str, nf, mu, R}", 158);
	if (_res) _res = _definepattern(mlp, (char *)"DeltaGap[str_, orderAlpha_, runAlpha_, runMass_, nf_, mZ_, aMz_, mT_,                 muT_, mB_, muB_, mC_, muC_, mu_, R_]", (char *)"{str, orderAlpha, runAlpha, runMass, nf, mZ, aMz, mT, muT, mB, muB, mC,                  muC, mu, R}", 159);
	if (_res) _res = _definepattern(mlp, (char *)"PSDelta[orderAlpha_, runAlpha_, nf_, mZ_, aMz_, mT_,                 muT_, mB_, muB_, mC_, muC_, mu_, R_, lg_]", (char *)"{orderAlpha, runAlpha, nf, mZ, aMz, mT, muT, mB, muB,                  mC, muC, mu, R, lg}", 160);
	if (_res) _res = _definepattern(mlp, (char *)"CoefMat[str_, nf_, s3_]", (char *)"{str, nf, s3}", 161);
	if (_res) _res = _definepattern(mlp, (char *)"wTilde[order_, nf_, gamma_, a0_, a1_]", (char *)"{order, nf, gamma, a0, a1}", 162);
	if (_res) _res = _definepattern(mlp, (char *)"kTilde[order_, nf_, gamma_, a0_, a1_]", (char *)"{order, nf, gamma, a0, a1}", 163);
	if (_res) _res = _definepattern(mlp, (char *)"AlphaQCD[str_, method_, order_, run_, nf_, Mz_, aMz_, mT_, muT_,                 mB_, muB_, mC_, muC_, mu_]", (char *)"{str, method, order, run, nf, Mz, aMz, mT, muT, mB, muB, mC,                  muC, mu}", 164);
	if (_res) _res = _definepattern(mlp, (char *)"AlphaQED[nf_, Mz_, aMz_, mT_, muT_, mB_, muB_, mC_, muC_, mu_]", (char *)"{nf, Mz, aMz, mT, muT, mB, muB, mC, muC, mu}", 165);
	if (_res) _res = _definepattern(mlp, (char *)"AlphaComplex[str_, method_, order_, run_, nf_, Mz_, aMz_, mT_,                 muT_, mB_, muB_, mC_, muC_, mu_]", (char *)"{str, method, order, run, nf, Mz, aMz, mT, muT, mB, muB, mC,                 muC, Re[mu], Im[mu]}", 166);
	if (_res) _res = _definepattern(mlp, (char *)"MSbarMass[order_, runAlpha_, run_, nf_, Mz_, aMz_, mT_, muT_, mB_, muB_,                 mC_, muC_, mu_]", (char *)"{order, runAlpha, run, nf, Mz, aMz, mT, muT, mB, muB, mC, muC, mu}", 167);
	if (_res) _res = _definepattern(mlp, (char *)"PoleMass[orderAlpha_, runAlpha_, order_, run_, nf_, Mz_, aMz_, mT_, muT_,                 mB_, muB_, mC_, muC_, mu_]", (char *)"{orderAlpha, runAlpha, order, run, nf, Mz, aMz, mT, muT, mB, muB, mC, muC,                  mu}", 168);
	if (_res) _res = _definepattern(mlp, (char *)"MSbarMassLow[order_, runAlpha_, run_, nf_, Mz_, aMz_, mT_, muT_, mB_,                 muB_, mC_, muC_, mu_]", (char *)"{order, runAlpha, run, nf, Mz, aMz, mT, muT, mB, muB, mC, muC, mu}", 169);
	if (_res) _res = _definepattern(mlp, (char *)"MSRMass[type_, method_, orderAlpha_, runAlpha_, order_, run_,                 nf_, Mz_, aMz_, mT_,muT_, mB_, muB_, mC_, muC_, lambda_, mu_,                 R_]", (char *)"{type, method, orderAlpha, runAlpha, order, run, nf, Mz, aMz, mT, muT, mB, muB,                  mC, muC, lambda, mu, R}", 170);
	if (_res) _res = _definepattern(mlp, (char *)"RSMass[type_, method_, orderAlpha_, runAlpha_, order_, run_, nf_, Mz_,                 aMz_, mT_, muT_, mB_, muB_, mC_, muC_, lambda_, R_]", (char *)"{type, method, orderAlpha, runAlpha, order, run, nf, Mz, aMz, mT, muT,                  mB, muB, mC, muC, lambda, R}", 171);
	if (_res) _res = _definepattern(mlp, (char *)"MSRVFNS[up_, type_, method_, orderAlpha_, runAlpha_, order_,                 run_, nf_, Mz_, aMz_, mT_, muT_, mB_, muB_, mC_, muC_, lambda_,                 mu1_, mu2_, R_]", (char *)"{up, type, method, orderAlpha, runAlpha, order, run, nf, Mz,                  aMz, mT, muT, mB, muB, mC, muC, lambda, mu1, mu2, R}", 172);
	if (_res) _res = _definepattern(mlp, (char *)"MSRTop[up_, type_, method_, orderAlpha_, runAlpha_, order_,                 run_, nf_, Mz_, aMz_, mT_, muT_, mB_, muB_, mC_, muC_, lambda_,                 mu1_, mu2_, mu3_, R_]", (char *)"{up, type, method, orderAlpha, runAlpha, order, run, nf, Mz,                  aMz, mT, muT, mB, muB, mC, muC, lambda, mu1, mu2, mu3, R}", 173);
	if (_res) _res = _definepattern(mlp, (char *)"NRQCD[n_, l_, j_, s_, charm_, scheme_, average_, method_,                 counting_, orderAlpha_, runAlpha_, order_, run_, nl_, mZ_, amZ_,                 mT_, muT_, mB_, muB_, mC_, muC_, lambda1_, lambda2_, lam_, mu_,                 R_]", (char *)"{n, l, j, s, charm, scheme, average, method, counting, orderAlpha,                  runAlpha, order, run, nl, mZ, amZ, mT, muT, mB, muB, mC, muC,                  lambda1, lambda2, lam, mu, R}", 174);
	if (_res) _res = _definepattern(mlp, (char *)"NRQCDDerCharm[n_, l_, j_, s_, charm_, scheme_, average_, method_,                 counting_, orderAlpha_, runAlpha_, order_, run_, nl_, mZ_, amZ_,                 mT_, muT_, mB_, muB_, mC_, muC_, lambda1_, lambda2_, lam_, mu_,                 R_, eps_]", (char *)"{n, l, j, s, charm, scheme, average, method, counting, orderAlpha,                  runAlpha, order, run, nl, mZ, amZ, mT, muT, mB, muB, mC, muC,                  lambda1, lambda2, lam, mu, R, eps}", 175);
	if (_res) _res = _definepattern(mlp, (char *)"NRQCDDerAlpha[n_, l_, j_, s_, charm_, scheme_, average_, method_,                 counting_, orderAlpha_, runAlpha_, order_, run_, nl_, mZ_, amZ_,                 mT_, muT_, mB_, muB_, mC_, muC_, lambda1_, lambda2_, lam_, mu_,                 R_, eps_]", (char *)"{n, l, j, s, charm, scheme, average, method, counting, orderAlpha,                  runAlpha, order, run, nl, mZ, amZ, mT, muT, mB, muB, mC, muC,                  lambda1, lambda2, lam, mu, R, eps}", 176);
	if (_res) _res = _definepattern(mlp, (char *)"MassIter[n_, l_, j_, s_, charm_, scheme_, average_, method_,                 counting_, orderAlpha_, runAlpha_, order_, run_, nl_, mZ_, amZ_,                 mT_, muT_, mB_, muB_, mC_, muC_, mass_, lambda1_, lambda2_,                 lam_, mu_, R_]", (char *)"{n, l, j, s, charm, scheme, average, method, counting, orderAlpha, runAlpha, order,                  run, nl, mZ, amZ, mT, muT, mB, muB, mC, muC, mass, lambda1,                  lambda2, lam, mu, R}", 177);
	if (_res) _res = _definepattern(mlp, (char *)"MassExpand[n_, l_, j_, s_, charm_, scheme_, average_, method_, counting_, orderAlpha_,                 runAlpha_, order_, run_, nl_, mZ_, amZ_, mT_, muT_, mB_, muB_,                 mC_, muC_, mass_, lambda1_, lambda2_, lam_, mu_, R_]", (char *)"{n, l, j, s, charm, scheme, average, method, counting, orderAlpha, runAlpha, order,                  run, nl, mZ, amZ, mT, muT, mB, muB, mC, muC, mass, lambda1,                  lambda2, lam, mu, R}", 178);
	if (_res) _res = _definepattern(mlp, (char *)"FindMass[ord_, n_, l_, j_, s_, iter_, charm_, scheme_, average_, method_,                 counting_, orderAlpha_, runAlpha_, order_, run_, nl_, mZ_, amZ_, mT_, muT_,                 mB_, muB_, mC_, muC_, mass_, lambda1_, lambda2_, lam_, mu_, R_]", (char *)"{ord, n, l, j, s, iter, charm, scheme, average, method, counting, orderAlpha,                  runAlpha, order, run, nl, mZ, amZ, mT, muT, mB, muB, mC, muC,                  mass, lambda1, lambda2, lam, mu, R}", 179);
	if (_res) _res = _definepattern(mlp, (char *)"FindEnergy[ord_, n_, l_, j_, s_, iter_, charm_, scheme_, average_, method_,                 counting_, orderAlpha_, runAlpha_, order_, run_, nl_, mZ_, amZ_, mT_, muT_,                 mB_, muB_, mC_, muC_, lambda1_, lambda2_, lam_, mu_, R_]", (char *)"{ord, n, l, j, s, iter, charm, scheme, average, method, counting, orderAlpha,                  runAlpha, order, run, nl, mZ, amZ, mT, muT, mB, muB, mC, muC,                  lambda1, lambda2, lam, mu, R}", 180);
	if (_res) _res = _definepattern(mlp, (char *)"MassError[ord_, n_, l_, j_, s_, iter_, charm_, scheme_, average_, method_,                 counting_, orderAlpha_, runAlpha_, order_, run_, nl_, mZ_, amZ_, mT_, muT_,                 mB_, muB_, mC_, muC_, mass_, lambda1_, lambda2_, lam_, mu0_,                 mu1_, deltaMu_, R0_, R1_, deltaR_, x_]", (char *)"{ord, n, l, j, s, iter, charm, scheme, average, method, counting, orderAlpha,                  runAlpha, order, run, nl, mZ, amZ, mT, muT, mB, muB, mC, muC,                  mass, lambda1, lambda2, lam, mu0, mu1, deltaMu, R0, R1, deltaR,                  x}", 181);
	...
	if (_res) _res = _definepattern(mlp, (char *)"OptimalR2[n_, orderAlpha_, runAlpha_, run_, nf_, Mz_,                 aMz_, mT_, muT_, mB_, muB_, mC_, muC_, mass_]", (char *)"{n, orderAlpha, runAlpha, run, nf, Mz, aMz, mT, muT, mB,                  muB, mC, muC, mass}", 195);
	...
	if (_res) _res = _definepattern(mlp, (char *)"mmFromJetMass[orderAlpha_, runAlpha_, order_, run_, nf_, Mz_, aMz_, mT_,                 muT_, mB_, muB_, mC_, muC_, muLambda_, R_, mu_]", (char *)"{orderAlpha, runAlpha, order, run, nf, Mz, aMz, mT, muT, mB, muB, mC,                  muC, muLambda, R, mu}", 198);
	if (_res) _res = _definepattern(mlp, (char *)"DeltaMSbar[order_, runAlpha_, nf_, Mz_, aMz_, mT_, muT_, mB_, muB_,                  mC_, muC_, mu_]", (char *)"{order, runAlpha, nf, Mz, aMz, mT, muT, mB, muB, mC, muC, mu}", 199);
	if (_res) _res = _definepattern(mlp, (char *)"Rhad[scheme_, orderAlpha_, runAlpha_, order_, nf_, Mz_, aMz_,                 mT_, muT_, mB_, muB_, mC_, muC_, mu_, Q_]", (char *)"{scheme, orderAlpha, runAlpha, order, nf, Mz, aMz, mT, muT, mB,                  muB, mC, muC, mu, Q}", 200);
	if (_res) _res = _definepattern(mlp, (char *)"SigmaHad[scheme_, current_, orderAlpha_, runAlpha_, order_,                 nf_, Mz_, GammaZ_, sin2ThetaW_, aMz_, aMzQED_, mT_, muT_, mB_,                 muB_, mC_, muC_, mu_, Q_]", (char *)"{scheme, current, orderAlpha, runAlpha, order, nf, Mz, GammaZ,                  sin2ThetaW, aMz, aMzQED, mT, muT, mB, muB, mC, muC, mu, Q}", 201);
	if (_res) _res = _definepattern(mlp, (char *)"SigmaRad[scheme_, current_, orderAlpha_, runAlpha_, order_,                 nf_, Mz_, GammaZ_, sin2ThetaW_, aMz_, aMzQED_, mT_, muT_, mB_,                 muB_, mC_, muC_, eH_, Q_, x_, theta_]", (char *)"{scheme, current, orderAlpha, runAlpha, order, nf, Mz, GammaZ,                  sin2ThetaW, aMz, aMzQED, mT, muT, mB, muB, mC, muC, eH, Q, x,                  theta}", 202);
	if (_res) _res = _definepattern(mlp, (char *)"SigmaRadCum[scheme_, current_, orderAlpha_, runAlpha_, order_,                 nf_, Mz_, GammaZ_, sin2ThetaW_, aMz_, aMzQED_, mT_, muT_, mB_,                 muB_, mC_, muC_, eH_, Q_, x0_, x1_, theta_]", (char *)"{scheme, current, orderAlpha, runAlpha, order, nf, Mz, GammaZ,                  sin2ThetaW, aMz, aMzQED, mT, muT, mB, muB, mC, muC, eH, Q, x0,                  x1, theta}", 203);
	if (_res) _res = _definepattern(mlp, (char *)"SigmaRadCone[scheme_, current_, orderAlpha_, runAlpha_, order_,                 nf_, Mz_, GammaZ_, sin2ThetaW_, aMz_, aMzQED_, mT_, muT_, mB_,                 muB_, mC_, muC_, eH_, Q_, x_, theta_, deltaTheta_]", (char *)"{scheme, current, orderAlpha, runAlpha, order, nf, Mz, GammaZ,                  sin2ThetaW, aMz, aMzQED, mT, muT, mB, muB, mC, muC, eH, Q, x,                  theta, deltaTheta}", 204);
	if (_res) _res = _definepattern(mlp, (char *)"SigmaRadConeCum[scheme_, current_, orderAlpha_, runAlpha_, order_,                 nf_, Mz_, GammaZ_, sin2ThetaW_, aMz_, aMzQED_, mT_, muT_, mB_,                 muB_, mC_, muC_, eH_, Q_, x0_, x1_, theta_, deltaTheta_]", (char *)"{scheme, current, orderAlpha, runAlpha, order, nf, Mz, GammaZ,                  sin2ThetaW, aMz, aMzQED, mT, muT, mB, muB, mC, muC, eH, Q, x0,                  x1, theta, deltaTheta}", 205);
	if (_res) _res = _definepattern(mlp, (char *)"RhadCoefs[nf_]", (char *)"{nf}", 206);
	if (_res) _res = _definepattern(mlp, (char *)"RhadMass[scheme_, current_, orderAlpha_, runAlpha_, runMass_,                 order_, nf_, Mz_, GammaZ_, sin2ThetaW_, aMz_, mT_, muT_, mB_,                 muB_, mC_, muC_, mu_, Q_]", (char *)"{scheme, current, orderAlpha, runAlpha, runMass, order, nf, Mz,                 GammaZ, sin2ThetaW, aMz, mT, muT, mB, muB, mC, muC, mu, Q}", 207);
	if (_res) _res = _definepattern(mlp, (char *)"SigmaMass[scheme_, current_, orderAlpha_, runAlpha_, runMass_,                 order_, nf_, Mz_, GammaZ_, sin2ThetaW_, aMz_, aMzQED_, mT_,                 muT_, mB_, muB_, mC_, muC_, mu_, Q_]", (char *)"{scheme, current, orderAlpha, runAlpha, runMass, order, nf, Mz,                 GammaZ, sin2ThetaW, aMz, aMzQED, mT, muT, mB, muB, mC, muC, mu,                 Q}", 208);
	if (_res) _res = _definepattern(mlp, (char *)"SigmaMassRad[scheme_, current_, orderAlpha_, runAlpha_,                 runMass_, order_, nf_, Mz_, GammaZ_, sin2ThetaW_, aMz_, aMzQED_,                 mT_, muT_, mB_, muB_, mC_, muC_, eH_, Q_, x_, theta_]", (char *)"{scheme, current, orderAlpha, runAlpha, runMass, order, nf, Mz,                 GammaZ, sin2ThetaW, aMz, aMzQED, mT, muT, mB, muB, mC, muC, eH,                 Q, x, theta}", 209);
	if (_res) _res = _definepattern(mlp, (char *)"SigmaMassRadCum[scheme_, current_, orderAlpha_, runAlpha_,                 runMass_, order_, nf_, Mz_, GammaZ_, sin2ThetaW_, aMz_, aMzQED_,                 mT_, muT_, mB_, muB_, mC_, muC_, eH_, Q_, x0_, x1_, theta_]", (char *)"{scheme, current, orderAlpha, runAlpha, runMass, order, nf, Mz,                 GammaZ, sin2ThetaW, aMz, aMzQED, mT, muT, mB, muB, mC, muC, eH,                 Q, x0, x1, theta}", 210);
	if (_res) _res = _definepattern(mlp, (char *)"SigmaMassRadCone[scheme_, current_, orderAlpha_, runAlpha_,                 runMass_, order_, nf_, Mz_, GammaZ_, sin2ThetaW_, aMz_, aMzQED_,                 mT_, muT_, mB_, muB_, mC_, muC_, eH_, Q_, x_, theta_, deltaTheta_]", (char *)"{scheme, current, orderAlpha, runAlpha, runMass, order, nf, Mz,                 GammaZ, sin2ThetaW, aMz, aMzQED, mT, muT, mB, muB, mC, muC, eH,                 Q, x, theta, deltaTheta}", 211);
	if (_res) _res = _definepattern(mlp, (char *)"SigmaMassRadConeCum[scheme_, current_, orderAlpha_, runAlpha_,                 runMass_, order_, nf_, Mz_, GammaZ_, sin2ThetaW_, aMz_, aMzQED_,                 mT_, muT_, mB_, muB_, mC_, muC_, eH_, Q_, x0_, x1_, theta_,                 deltaTheta_]", (char *)"{scheme, current, orderAlpha, runAlpha, runMass, order, nf, Mz,                 GammaZ, sin2ThetaW, aMz, aMzQED, mT, muT, mB, muB, mC, muC, eH,                 Q, x0, x1, theta, deltaTheta}", 212);
	if (_res) _res = _definepattern(mlp, (char *)"RQCD[scheme_, runAlpha_, runMass_, ordMass_, order_, ord1S_,                 R1S_, method_, lambda_, gt_, Mz_, aMz_, mT_, mu_, Q_]", (char *)"{scheme, runAlpha, runMass, ordMass, order, ord1S, R1S, method,                 lambda, gt, Mz, aMz, mT, mu, Q}", 213);
	if (_res) _res = _definepattern(mlp, (char *)"RExp[scheme_, runAlpha_, runMass_, ordMass_, order_, ord1S_,                 R1S_, method_, lambda_, gt_, Mz_, aMz_, mT_, mu_, nu_, Q_]", (char *)"{scheme, runAlpha, runMass, ordMass, order, ord1S, R1S, method,                 lambda, gt, Mz, aMz, mT, mu, nu, Q}", 214);
	if (_res) _res = _definepattern(mlp, (char *)"Rmatched[scheme_, runAlpha_, runMass_, ordMass_, order_, ord1S_,                 R1S_, method_, lambda_, gt_, Mz_, aMz_, mT_, mu_, nu_, v1_, v2_,                 Q_]", (char *)"{scheme, runAlpha, runMass, ordMass, order, ord1S, R1S, method,                 lambda, gt, Mz, aMz, mT, mu, nu, v1, v2, Q}", 215);
	if (_res) _res = _definepattern(mlp, (char *)"SigmaMatched[scheme_, runAlpha_, runMass_, ordMass_, order_, ord1S_,                 R1S_, method_, lambda_, gt_, Mz_, gammaZ_, sinW_, aMz_, aMzQED_,                 mT_, mu_, nu_, v1_, v2_, Q_]", (char *)"{scheme, runAlpha, runMass, ordMass, order, ord1S, R1S, method,                 lambda, gt, Mz, gammaZ, sinW, aMz, aMzQED, mT, mu, nu, v1, v2, Q}", 216);
	if (_res) _res = _definepattern(mlp, (char *)"SigmaMatchedRad[scheme_, runAlpha_, runMass_, ordMass_,                 order_, ord1S_, R1S_, method_, lambda_, gt_, Mz_, gammaZ_,                 sinW_, aMz_, aMzQED_, mT_, mu_, nu_, v1_, v2_, Q_, x_, theta_]", (char *)"{scheme, runAlpha, runMass, ordMass, order, ord1S, R1S, method,                 lambda, gt, Mz, gammaZ, sinW, aMz, aMzQED, mT, mu, nu, v1, v2,                 Q, x, theta}", 217);
	if (_res) _res = _definepattern(mlp, (char *)"SigmaMatchedRadCum[scheme_, runAlpha_, runMass_, ordMass_,                 order_, ord1S_, R1S_, method_, lambda_, gt_, Mz_, gammaZ_,                 sinW_, aMz_, aMzQED_, mT_, mu_, nu_, v1_, v2_, Q_, x0_, x1_,                 theta_]", (char *)"{scheme, runAlpha, runMass, ordMass, order, ord1S, R1S, method,                 lambda, gt, Mz, gammaZ, sinW, aMz, aMzQED, mT, mu, nu, v1, v2,                 Q, x0, x1, theta}", 218);
	if (_res) _res = _definepattern(mlp, (char *)"SigmaMatchedRadCone[scheme_, runAlpha_, runMass_, ordMass_,                 order_, ord1S_, R1S_, method_, lambda_, gt_, Mz_, gammaZ_,                 sinW_, aMz_, aMzQED_, mT_, mu_, nu_, v1_, v2_, Q_, x_, theta_,                 deltaTheta_]", (char *)"{scheme, runAlpha, runMass, ordMass, order, ord1S, R1S, method,                 lambda, gt, Mz, gammaZ, sinW, aMz, aMzQED, mT, mu, nu, v1, v2,                 Q, x, theta, deltaTheta}", 219);
	if (_res) _res = _definepattern(mlp, (char *)"SigmaMatchedRadConeCum[scheme_, runAlpha_, runMass_, ordMass_,                 order_, ord1S_, R1S_, method_, lambda_, gt_, Mz_, gammaZ_,                 sinW_, aMz_, aMzQED_, mT_, mu_, nu_, v1_, v2_, Q_, x0_, x1_,                 theta_,deltaTheta_]", (char *)"{scheme, runAlpha, runMass, ordMass, order, ord1S, R1S, method,                 lambda, gt, Mz, gammaZ, sinW, aMz, aMzQED, mT, mu, nu, v1, v2,                 Q, x0, x1, theta, deltaTheta}", 220);
	if (_res) _res = _definepattern(mlp, (char *)"RmatchedList[scheme_, runAlpha_, runMass_, ordMass_, order_, ord1S_,                 R1S_, method_, lambda_, gt_, Mz_, aMz_, mT_, mu_, nu_, v1_, v2_,                 Q0_, Q1_, deltaQ_]", (char *)"{scheme, runAlpha, runMass, ordMass, order, ord1S, R1S, method,                 lambda, gt, Mz, aMz, mT, mu, nu, v1, v2, Q0, Q1, deltaQ}", 221);
	if (_res) _res = _definepattern(mlp, (char *)"LambdaQCD[scheme_, order_, runAlpha_, run_, nf_, Mz_, aMz_, mT_, muT_,                  mB_, muB_, mC_, muC_, mu_]", (char *)"{scheme, order, runAlpha, run, nf, Mz, aMz, mT, muT, mB, muB, mC, muC, mu}", 222);
	if (_res) _res = _definepattern(mlp, (char *)"Kernel[n_, width_, w_, mu_, p_]", (char *)"{n, width, w, mu, p}", 223);
	if (_res) _res = _definepattern(mlp, (char *)"GammaDerList[n_, w_]", (char *)"{n, w}", 224);
	if (_res) _res = _definepattern(mlp, (char *)"polyGamma[n_, w_]", (char *)"{n, w}", 225);
...
#endif
{
	return _MLDoCallPacket( mlp, _tramps, 229);
} /* MLDoCallPacket */

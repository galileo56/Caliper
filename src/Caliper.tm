...
:Evaluate:  RQCD::usage = "RQCD[scheme, orderAlpha, runAlpha, runMass, order, gt, Mz, aMz, mT, h, Q] computes the massive total hadronic cross section for an unstable top quark."

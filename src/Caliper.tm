...
:Evaluate:  RSMass::usage = "RSMass[type, orderAlpha, runAlpha, order, run, nf, Mz, aMz, mT, muT, mB, muB, mC, muC, R] computes the RS-scheme running of the quark masses."
...
:Evaluate:  Chi2MinNRQCD::usage = "Chi2MinNRQCD[qnlist, datalist, charm, scheme, average, method, counting, orderAlpha, runAlpha, order, run, n, nl, mZ, amZ, mT, muT, mB, muB, mC, muC, lambda1, lambda2, lam, mu, R] minimizes the chi2 value for quarkonium."
:Evaluate:  Chi2MinAlphaNRQCD::usage = "Chi2MinAlphaNRQCD[qnlist, datalist, charm, scheme, average, method, counting, orderAlpha, runAlpha, order, run, n, nl, mZ, amZ, mT, muT, mB, muB, mC, muC, lambda1, lambda2, lam, mu, R] minimizes the chi2 value for quarkonium."
...
:Begin:
:Function:      rsmass
:Pattern:       RSMass[type_, orderAlpha_, runAlpha_, order_, run_, nf_, Mz_,
                aMz_, mT_, muT_, mB_, muB_, mC_, muC_, R_]
